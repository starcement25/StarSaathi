          ...
          if($isverify==1){
                ...
                if(count($rowsmenudetails)>0){
                    ...
                    $contents.="<data>";
                          ...
                          <realtime_validation><![CDATA['.mb_convert_encoding($rowsmenudetails->realtime_validation, 'UTF-8', 'UTF-8').']]></realtime_validation>
            							<last_update_time><![CDATA['.mb_convert_encoding($contentsdatetime, 'UTF-8', 'UTF-8').']]></last_update_time>';
            				$contents.="</data>";
                }
                $contents .= "</recordset>";
              	$datetime = gmdate('Y-m-d H:m:s',strtotime('+330 minute'));
              	$url = url('/api/v2/menudetails?nick_name='.$nick_name);
