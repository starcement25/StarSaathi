      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    {{ Form::open(array('url' => '','class'=>'form-horizontal form-label-left','id'=>'monthlyreport')) }}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            @php $current_month_year = date('M')."-".date('Y'); @endphp
                            {{ Form::select('month_select', [null=>'Please Select'] +$monthlist, null, ['id'=>'month_select','class'=> 'form-control']) }}
                    ...
                    function frmSub(){
                      ...
                      $.ajax({
                       url: '{{url("showmontlyactivityanalysis")}}',
                       type: "post",
                         data: {
                            _token: CSRF_TOKEN,
                            employee :employee,
                         ...
                         success: function(resp) {
                           $('#loading').html("").hide();
                           $("#montly_activity_analysis").html(resp);
                         }
                      });
                    }
                    $(".btnreport").on("click", function(e){
                        e.preventDefault();
                        $('#monthlyreport').attr('action', "{{ url('/csvmontlyactivityanalysis') }}").submit();
                    });
                ...
                <div class="x_panel">
                  <div class="x_content">
                    <div class="table-responsive">
                      ...
                      <table class="table table-striped jambo_table bulk_action" id="montly_activity_analysis">
