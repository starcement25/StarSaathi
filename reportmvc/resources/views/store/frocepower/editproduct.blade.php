                 ...
                 <div class="x_panel">
                   <div class="col-md-3 col-sm-3 col-xs-2">
                      <div class="row form-group">
                            <div class="col-xs-12">
                              <div class="list-group list-cust">
                                    ...
                                    <a href="#" class="list-group-item active">Product Details</a>
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-10">
                      {{ Form::open(array('url' => 'store/editproduct/'.$storeproduct->user_id,'id'=>'createuser','class'=>'form-signin','files'=>'true','method'=>'patch')) }}
                          		                    ...
                          		                    <div class="col-md-12 column">
                          			                       <table class="table table-bordered table-hover" id="tab_logic">
                                                              ...
                                                              @foreach ($productdetails as $key => $val)
                                                    					<tr>
                                                                @php
                                                                $excludearraylist=array('0','1','2','21');
                                                                ...
                                                                @endphp
                                                                 ...
                                                                 @endphp
                                                                 {{ Form::text($val->ColumnName, $storeproduct->$colname, array(
                                                                     'class' => 'form-control',
                                                                     'id' =>$val->ColumnName,
                                                                 ...
                                                                 @php
                                                                   ...
                                                                   {
                                                                 @endphp
                                                                 <input type="radio" name="{{$val->ColumnName}}" value="yes" @php if($storeproduct->$colname =='yes') { @endphp checked="" @php } @endphp> Yes
                                                                 <input type="radio" name="{{$val->ColumnName}}" value="no" @php if($storeproduct->$colname =='no') { @endphp checked="" @php } @endphp> No
                                                                 @php
                                                                   }
