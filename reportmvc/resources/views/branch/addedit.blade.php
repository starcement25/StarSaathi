    ...
    <div class="right_col" role="main">
      ...
      <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    {{ Form::open(array('url' => 'branch','class'=>'form-signin')) }}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          {{ Form::text('brach_master_code', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {{ Form::text('brach_master_name', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {{ Form::text('brach_location', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {{ Form::text('brach_state', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {{ Form::text('brach_emailid', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {{ Form::text('brach_account_emailid', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {{ Form::text('brach_alternative_emailid', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {{ Form::text('plamt_name', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          {{ Form::text('brach_costcenter', null, array(
          								    'class' => 'form-control',
          								    'id' => '',
