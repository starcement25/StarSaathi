...
$totres_em = mysql_num_rows($res_em);
	...
	if($order_status==="Success"){
		...
		echo $final_email=substr($email_hierarchy,0,-1).','.'dipankarc@coral.in'.','.'emovesfa@starcement.co.in';
		$send_mail='dipankarc@coral.in';
		...
		$send_mail = send_the_mail($send_mail,$subject,$message);
	}
	echo "</center>";
?>
