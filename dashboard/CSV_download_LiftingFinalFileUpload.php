...
$sql_filename = "SELECT CSV_file_name FROM lifting_final_file_upload_csv WHERE id = $file_upload_id LIMIT 1";
...
$sql = "SELECT
    ...
    FROM lifting_final_allocation_data
     WHERE file_upload_id = $file_upload_id AND linked_dealer_code = '$sswa_selected_dealer_code'";
