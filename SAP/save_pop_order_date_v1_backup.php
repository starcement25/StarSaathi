...
$sqlin = "insert into $t_apperpdo_pop (`order_date`,`customer_code`,`dns_customer_code`,`prod_code`,`dns_prod_code`,`prod_display_name`,`QTY`,`address`,`pin`,`remarks`) values('$order_date','$customer_code','$dns_customer_code','','$dns_prod_code','$prod_desc','$qty','$address','$pin','$remark')";
