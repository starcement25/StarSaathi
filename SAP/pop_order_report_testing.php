...
<td>
    <div>
        <select class="form-control the_status" id="the_status_<?php echo $order_id; ?>" e_order_id="<?php echo $order_id; ?>">
            <option value="selected" <?php if ($order_status == "selected") echo "selected"; ?>>Selected</option>
            <option value="Cancelled & Refund Initiated" <?php if ($order_status == "cancelled_and_refund_initiated") echo "selected"; ?>>Cancelled & Refund Initiated</option>
            <option value="Refund Completed" <?php if ($order_status == "refund_completed") echo "selected"; ?>>Refund Completed</option>
        </select>
