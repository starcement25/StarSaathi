	...
	//End Insert into the Survey output table for new survey id
		for($countarr=0;$countarr<count($survey_array);$countarr++)
		{
			...
			if($nick_name=='EMAMI'){
				...
				if(mysql_query($sqlupdatecustomeremail))
					{
						$flag=5;
					}
					else
			...
			if($nick_name=='TECPL')
			{
				...
				$rskioskdetails=mysql_query($sqlkioskdetails);
				$rowkioskdetails=mysql_fetch_array($rskioskdetails);
				...
				$rskioskdivisiondetails=mysql_query($sqlkioskdivisiondetails);
				$rowkioskdivisiondetails=mysql_fetch_array($rskioskdivisiondetails);
				...
				$rskioskzonedetails=mysql_query($sqlkioskzonedetails);
				$rowkioskzonedetails=mysql_fetch_array($rskioskzonedetails);
				...
				if(mysql_query($sqlkiosktransaction))
				{
					$flag=5;
				}
				else
			...
			if($nick_name=='EMAMI' || $nick_name=='EMAMIT')
			{
				if(${customer_name.$surveytansid_array_mailbody[$countarr]}!=''){
					...
					if(mysql_query($sqlcreatecustomer))
					{
						$flag=5;
					}
					else
