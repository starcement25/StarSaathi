...
$apporderno = "ST".$new_order_id_val;
...
values('$apporderno','$SAP_order_date','$SAP_order_time','$SAP_customer_code','$SAP_sub_dealer_code','$freight','$the_SAP_destination','$dns_prod_code','$qty','TO','$the_SAP_plant','','$remarks','$delivery_point','$remarks_text','$additional_data_1')";
	...
	//Live table data insert 
			$data_main = array(
				...
				'order_for'            => $order_for_new_in,
				'consignee_name'       => $consignee_name,
				'consignee_address'    => $consignee_address,
				'sub_dealer_code'      => $sub_dealer_code,
				'dns_sub_dealer_code'  => ${'dns_sub_dealer_code'.$cntordata},
				...
				'dump_code'            => $dump_code,
				'dump_name'            => $dump_name,
				'order_from'           => $user_type,
				'order_by'             => $login_user_id,
				'dealer_truck'         => $dealer_truck
			);
			...
			$data_sap = array(
				...
				'DATE'               => $SAP_order_date,
				'time'               => $SAP_order_time,
				'Cust_Code'          => $SAP_customer_code,
				'Consignee_Code'     => $SAP_sub_dealer_code,
				'Freight'            => $freight,
				'DestinationCode'    => $the_SAP_destination,
				'ProductCode'        => $dns_prod_code,
				'Qty'                => $qty,
				'Unit'               => 'TO',
				'PLANT'              => $the_SAP_plant,
				'OrderNo'            => '', // empty string
				'Remarks'            => $remarks,
				'Delivery_point'     => $delivery_point,
				'Remarks_text'       => $remarks_text,
			...
			$post_data = array(
				'main_order'  => $data_main,
				'sap_order'   => $data_sap
			);
			 if(lIVE_INSERT=='TRUE'){
			$url = BASE_URL ."downtime/insert_live_order_t_apperpdo.php";
