...
$start_year_month_split = explode("-",$start_date);
$start_monthNum  = $start_year_month_split[1];
$start_year = $start_year_month_split[0];
$start_monthName = date('M', mktime(0, 0, 0, $start_monthNum, 10));

$end_year_month_split = explode("-",$end_date);
$end_monthNum  = $end_year_month_split[1];
$end_year = $end_year_month_split[0];
$end_monthName = date('M', mktime(0, 0, 0, $end_monthNum, 10));

$validn_year_month_split = explode("-",$validn_date);
$validn_monthNum  = $validn_year_month_split[1];
$validn_year = $validn_year_month_split[0];
$validn_monthName = date('M', mktime(0, 0, 0, $validn_monthNum, 10));
...
if($yellowcard_row_check>0){
    ...
    <table width="60%" style="border-collapse:collapse; border:1px solid #A92A61;"  cellpadding="2px">
      ...
      <tr>
        <td align="right">Start Month:</td>
        <td><?php echo $start_monthName." ".$start_year ?></td>
      </tr>
	  <tr>
        <td align="right">End Month:</td>
        <td><?php echo $end_monthName." ".$end_year ?></td>
      </tr>
	  <tr>
        <td align="right">Validation Month:</td>
        <td><?php echo $validn_monthName." ".$validn_year ?></td>
      </tr>
    </table>
    <br /><br />
