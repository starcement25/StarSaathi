...
$page_curr_title = "Star Cement Down time Customer Portal";
...
<head>
    ...
    <title>Star Cement Down time Customer Portal</title>
    <!-- Favicon-->
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
					...
					//$sql1 = "select * from $menu_master where `menu_id` in(select `menu_id` from $selected_menu_for_user where `user_id`='$_SESSION[sswa_user_id]') order by `menu_id` asc";
                    $sql1 = "select * from $menu_master where `menu_id` in(select `menu_id` from $selected_menu_for_user where `user_id`='$_SESSION[sswa_user_id]') and menu_id='1' order by `menu_id` asc";
