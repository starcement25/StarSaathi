...
// Get The Field Name
$slno_cnt = 1;
$output .= '"Allocation Date Time","APPORDERNO","Dispatch Date","Linked Dealer Code","Linked Dealer SAP Code","Linked Dealer Name","Sub Dealer/RSSD Code","Sub Dealer/RSSD SAP Code","Sub Dealer/RSSD Name","Branch","Month","Product Name","Total Dispatch qty","Allocated qty","Remaining Allocation qty","Challan no"';
$output .= "\n";
...
while ($row1 = mysql_fetch_array($sql)) {
	...
	$output .= '"' .$date_and_time. '","' .$APPORDERNO. '","' .$dispatch_date. '","' . $linked_dealer_code . '","' . $linked_dealer_sap_code . '","' . $linked_dealer_name . '","' . $sub_dealer_rssd_code . '","' . $sub_dealer_rssd_sap_code . '","' . $sub_dealer_rssd_name . '","' . $branch . '","' . $month . '","' . $prod_display_name . '","' . $total_despatch_qty . '","' . $row1["total_allocation_qty"] . '","' . $remaining_allocation_qty . '","' . $challan_no . '"';
	$output .= "\n";
	$slno_cnt++;
}
// Download the file
