...
$the_file_name = "surveyList_fy_21_22_23_".$curr_date.".csv";
$server_url = "http://".$_SERVER['SERVER_NAME']."/SAP/";
$home_url = $server_url."admin/";
$output ="";
$output .= '"Dealer_ID","Dealer_SAP_Code","Dealer_Name","Phone","Device_Type","App_Version","Branch_Name","Branch_Code","Branch_DNS_Code","is_return_fy21_22","is_clmd_morthn_50k_tdstcs_fy22_23","is_turnover_exceeds_10_crores_fy22_23","PAN","TAN","Submitted_On","PDF Link"';
$output .="\n";
...
$output .= '"'.$sf_dealer_id.'","'.$sf_sf_dealer_sap_code.'","'.$sf_dealer_name.'","'.$sf_dealer_mobile.'","'.$sf_device_type.'","'.$sf_app_version.'","'.$sf_branch_name.'","'.$sf_branch_code.'","'.$sf_dns_branch_code.'","'.$sf_is_return_fy21_22.'","'.$sf_is_clmd_morthn_50k_tdstcs_fy22_23.'","'.$sf_is_turnover_exceeds_10_crores_fy22_23.'","'.$sf_pan.'","'.$sf_tan.'","'.$sf_submitted_datetime.'","'.$the_pdf_link.'"';
