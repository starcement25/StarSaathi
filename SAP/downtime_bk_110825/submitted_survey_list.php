...
$add_page_name = "submitted_survey_list.php";
$page_name = "submitted_survey_list.php";
$cnt = 0;
$countrow = 1;
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>Survey List (<?php echo $total_pgres;?>)&nbsp;&nbsp;
                          <a href="export_submitted_survey_list.php" class="btn bg-red waves-effe">Export&nbsp;Survey&nbsp;List</a> &nbsp;
                          </h2>
                            <div class="row clearfix">
