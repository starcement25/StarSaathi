...
$url_ck1 = 'https://PRDAPP1.starcement.co.in:44310/sap/opu/odata/sap/ZFI_CUST_LEDGER_ODATA_SRV/ZFI_CUST_LEDGER_STSet?$format=json'.str_replace(" ","%20",$the_filter).'&sap-client=900';
...
if(count($app_results_arr)>0){
	foreach($app_results_arr as $app_results_aval){
		...
		$output .= "<tr>
          ...
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:10%\">".$quayntity."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:15%\">".$CrAmount."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:10%\">".$DrAmount."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:15%\">".$total_balance."</td>
        </tr>";
 ...
 $output .= "<tfoot><tr>
          ...
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:10%\"><b>".$total_qty."</b></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:15%\"><b>".$total_CrAmount."</b></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:10%\"><b>".$total_DrAmount."</b></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:15%\"><b>".$total_balance."</b></td>
        </tr></tfoot>";
