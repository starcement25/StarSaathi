...
$whr_str .= "$aand ($customer_master.`customer_code` like '%$search_array_val%' or $customer_master.`dns_customer_code` like '%$search_array_val%' or $customer_master.`customer_name` like '%$search_array_val%' or $employee_kyc_master.`whatsapp_no` like '%$search_array_val%' ) ";
...
$pgsql = "select $employee_kyc_master.`customer_code` from $employee_kyc_master left join $customer_master on $employee_kyc_master.`customer_code`=$customer_master.`customer_code` $new_whr_str";
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>Customer KYC Details (<?php echo $total_pgres;?>)&nbsp;&nbsp;
...
<span style="display:block; clear:both;"></span>
 <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
<?php
$sql1 = "select $employee_kyc_master.*,$customer_master.`dns_customer_code`,$customer_master.`customer_name` from $employee_kyc_master left join $customer_master on $employee_kyc_master.`customer_code`=$customer_master.`customer_code` $new_whr_str order by $employee_kyc_master.`last_updated_datetime` desc limit $start_from,$limit";
