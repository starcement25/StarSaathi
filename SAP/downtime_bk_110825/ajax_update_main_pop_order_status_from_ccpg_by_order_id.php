...
$the_url = "https://starsaathi.com/SAP/ccavenue_pg/check_pop_order_payment_status_ccavenue_ne.php?order_id=".$mordpop_id;
$the_url_fail_safe = "https://starsaathi.com/SAP/ccavenue_pg/check_pop_order_payment_status_ccavenue.php?order_id=".$mordpop_id;		
}else if($customer_region=="ROE"){
$the_url = "https://starsaathi.com/SAP/ccavenue_pg/check_pop_order_payment_status_ccavenue.php?order_id=".$mordpop_id;	
$the_url_fail_safe = "https://starsaathi.com/SAP/ccavenue_pg/check_pop_order_payment_status_ccavenue_ne.php?order_id=".$mordpop_id;
}
