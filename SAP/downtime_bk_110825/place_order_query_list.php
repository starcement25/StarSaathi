...
$page_name = "place_order_query_list.php";
$cnt = 0;
$countrow = 1;
...
$pgsql = "select $order_query.*,$customer_master.`customer_name` from $order_query left join $customer_master on $order_query.`customer_code`=$customer_master.`customer_id` where $order_query.`order_id`!=''   $new_whr_str ";
    ...
    <div class="wrapper_scrl_div"></div>
                            ...
                            <div class="table-responsive table-container">  
                                <table class="table-bordered">
                                    ...
                                    <tbody>
<?php
$sql1 = "select $order_query.*,$customer_master.`customer_name`,$customer_master.`branch_code` from $order_query left join $customer_master on $order_query.`customer_code`=$customer_master.`customer_id` where $order_query.`order_id`!=''  $new_whr_str order by $order_query.`id` desc limit $start_from,$limit";
...
<td><?php echo $linked_dealer_id;?></td>
<td><?php echo $linked_dealer_name;?>
<td><?php echo $branch_name;?>
...
/*jQuery('#trn_branch_id').change(function(){
	...
	jQuery(".srch_btn").click(function(){
		...
		var dtstring ="";
		var amp = "";
		if(trn_branch_id!="" || sl_day_wise!="" || srch_order_dtls!=""){
		if(trn_branch_id!=""){
		if(qstring==""){
