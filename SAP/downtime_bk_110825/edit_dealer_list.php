...
<div class="col-sm-12">
    ...
    <label for="dealer_id">Dealer ID : <?php echo $dns_emp_id;?></label>
    </div>
	<div class="form-group">
    <label for="dealer_otp">OTP : <?php echo $sms_otp;?></label>
    </div>
    <div class="form-group">
    ...
    <select class="form-control dlr_status" name="dlr_status" id="dlr_status" style="width:50px;">
    <?php
    
	if(count($ai_status_arr)>0){
		foreach($ai_status_arr as $ai_status_arr_val){ ?>
			<option value="<?php echo $ai_status_arr_val;?>" <?php if($ai_status_arr_val==$acedns){ ?> selected="selected" <?php } ?>><?php echo $ai_status_arr_val;?></option>
		<?php }
	}
	?>
...
<div class="form-group" style="text-align:center;">
    ...
    <input type="hidden" name="upthe_dns_emp_code" value="<?php echo $dns_emp_code;?>" />
