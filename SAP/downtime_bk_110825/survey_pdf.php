...
$the_dealer_id = "";
$the_sf_dealer_sap_code = "";
$the_dealer_name = "";
$the_dealer_mobile = "";
$the_branch_name = "";
$the_sf_pan = "";
$the_sf_tan = "";
$the_sf_is_return_fy21_22 = "NO";
$the_sf_is_clmd_morthn_50k_tdstcs_fy22_23 = "NO";
$the_sf_is_turnover_exceeds_10_crores_fy22_23 = "NO";
...
$the_sf_dealer_sap_code = $row3["sf_dealer_sap_code"] ? trim($row3["sf_dealer_sap_code"]) : "";
...
$the_sf_is_return_fy21_22 = $row3["sf_is_return_fy21_22"] ? trim($row3["sf_is_return_fy21_22"]) : "NO";
$the_sf_is_clmd_morthn_50k_tdstcs_fy22_23 = $row3["sf_is_clmd_morthn_50k_tdstcs_fy22_23"] ? trim($row3["sf_is_clmd_morthn_50k_tdstcs_fy22_23"]) : "NO";
$the_sf_is_turnover_exceeds_10_crores_fy22_23 = $row3["sf_is_turnover_exceeds_10_crores_fy22_23"] ? trim($row3["sf_is_turnover_exceeds_10_crores_fy22_23"]) : "NO";
$the_sf_pan = $row3["sf_pan"] ? trim($row3["sf_pan"]) : "";
$the_sf_tan = $row3["sf_tan"] ? trim($row3["sf_tan"]) : "";
...
<img class="img-responsive" style="margin:0 auto; padding-top:0px;width: 138px;" src="images/logo_header.jpeg" alt="logo">
</div>
<div class="panel panel-default">
  <div class="panel-body">
  <h6>DECLARATION FOR COMPLIANCE UNDER SECTIONS 206AB/ 206CCA/ 194Q/ 206C (1H) OF THE INCOME TAX ACT, 1961 </h6>
  </div>
</div>
...
<div class="panel panel-default" style="margin-bottom:10px !important;">
  ...
  <label for="usr" style="font-size:10px !important;font-weight: 700;" >Dealer SAP Code</label><br />
  <?php echo $the_sf_dealer_sap_code;?>
  </div>
  </div>
</div>
<div class="panel panel-default" style="margin-bottom:10px !important;">
...
<div class="panel panel-default" style="margin-bottom:10px !important;">
  <div class="panel-body" style="padding:5px;">
  <div class="form-group" style="margin-bottom:0px;">
  <label for="usr" style="font-size:10px !important;">Kindly confirm if you have filed return for FY21-22 for your Dealership:</label><br />
 <?php echo $the_sf_is_return_fy21_22;?>
  </div>
  </div>
</div>
<div class="panel panel-default" style="margin-bottom:10px !important;">
  <div class="panel-body" style="padding:5px;">
  <div class="form-group" style="margin-bottom:0px;">
  <label for="usr" style="font-size:10px !important;">Kindly confirm if you have claimed more than Rs. 50,000 in TDS/TCS in FY22-23 for your Dealership:</label>
   <br />
 <?php echo $the_sf_is_clmd_morthn_50k_tdstcs_fy22_23;?>
  </div>
  </div>
</div>
<div class="panel panel-default" style="margin-bottom:10px !important;">
  <div class="panel-body" style="padding:5px;">
  <div class="form-group" style="margin-bottom:0px;">
  <label for="usr" style="font-size:10px !important;">Kindly confirm if Turnover of your Dealership exceeded/will exceed Rs. 10 Crores for FY22-23 :</label>
   <br />
 <?php echo $the_sf_is_turnover_exceeds_10_crores_fy22_23;?>
  </div>
  </div>
</div>
...
<div class="panel panel-default" style="margin-bottom:10px !important;">
  <div class="panel-body" style="padding:5px;">
  <div class="form-group" style="margin-bottom:0px;">
  <label for="usr" style="font-size:10px !important;">My TAN is</label><br />
  <?php echo $the_sf_tan;?>
  </div>
  </div>
</div>
...
<div class="panel panel-default" style="margin-bottom:10px !important;">
  ...
  <label for="usr" style="font-size:10px !important;">Declaration:</label><br />
    <label style="font-size:10px !important;">I hereby declare that the information furnished above is true to the best of my knowledge.</label>
  </div>
  </div>
</div>
...
$mpdf->writeHTML($body);
if($the_sf_dealer_sap_code!=""){
	$the_filr_name = $the_sf_dealer_sap_code.".pdf";
}else{
