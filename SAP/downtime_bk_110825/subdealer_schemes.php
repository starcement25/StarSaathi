        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>Subdealer Schemes (<?php echo $total_pgres;?>)&nbsp;&nbsp;&nbsp;&nbsp;
                          <a href="<?php echo $add_page_name;?>" class="btn bg-red waves-effe">ADD NEW SUBDEALER SCHEME</a>
...
ldr_elmnt.html(img1);
jQuery.ajax({
url: 'ajax_update_subdealer_scheme_date.php',
type: 'post',
dataType: 'json',
