...
$the_start_date = $_REQUEST["the_start_date"] ? addslashes(trim($_REQUEST["the_start_date"])) :'';
$the_end_date = $_REQUEST["the_end_date"] ? addslashes(trim($_REQUEST["the_end_date"])) : "";
$user_type = $_REQUEST["user_type"];
$sswa_selected_customer_code = $_REQUEST["the_customer_code"];
