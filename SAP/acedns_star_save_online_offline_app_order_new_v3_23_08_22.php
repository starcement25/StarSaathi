...
$customer_master = "customer_master";
if($the_customer_code!=""){
$sql1 = "select LZONE from $SAP_customer_master where KUNNR=(select customer_id from $customer_master where `customer_code`='$the_customer_code') ORDER BY AEDAT ASC,ADDITIONAL_DATA1 ASC";	
$res1 = mysql_query($sql1);
$totres1 = mysql_num_rows($res1);
	if($totres1>0){
		$row1 = mysql_fetch_assoc($res1);
