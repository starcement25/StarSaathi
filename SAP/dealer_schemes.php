...
$getCustomerSql = "SELECT customer_code, branch_code, cust_type
...
$branch_code   = trim($getCustomerRow['branch_code']);
$cust_type     = trim($getCustomerRow['cust_type']);

/* =========================================================
   SELECT PDF TABLE BASED ON CUSTOMER TYPE
========================================================= */

if ($cust_type == "RSSD" || $cust_type == "Sub Dealer") {

    $branch_pdf_table = "subdealer_branch_schemes_PDF";

} else {

    $branch_pdf_table = "branch_schemes_PDF";
}
...
echo json_encode(array(
    ...
    "data"    => array(
        ...
        "cust_type"       => $cust_type,
        "branch_pdf_table"=> $branch_pdf_table,
