...
SAPW.dec_prev_y_achievement FROM self_appraisal_product_wise SAPW,product_master PM WHERE SAPW.prod_code = PM.prod_code  AND SAPW.customer_code='".$dns_customer_code."'";
