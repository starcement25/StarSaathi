...
//https://PRDAPP1.starcement.co.in:44310/sap/opu/odata/sap/ZOVW_DELIVERY_CDS/ZOVW_DELIVERY(p_Dt=datetime'2023-04-18T00:00:00',p_tmFrm=time'PT12H00M01S',p_tmTo=time'PT13H00M59S')/Set?$format=json&sap-client=900
 ...
 $url_ck1 = 'https://starfiori.starcement.co.in:'.SRARFIORI_PORT_NO.'/sap/opu/odata/sap/ZOVW_DELIVERY_CDS/ZOVW_DELIVERY(p_Dt=datetime\''.$the_date.'\',p_tmFrm=time\''.$the_from_time.'\',p_tmTo=time\''.$the_to_time.'\')/Set?$format=json&sap-client=900';
...
$sql_clupd = "update $t_dochallan set `ERPORDERNO`='$SoNo',`ERPORDERDT`='$SoDate_format',`SoTime`='$SoTime',`InvItem`='$InvItem',`CHALLANDT`='$InvDate_format',`InvTime`='$InvTime',`QTY`='$SoQty',`CHALLANQTY`='${"InvQty".$InvNo}',`TRUCKNO`='$TruckNo',`DRIVERNO`='$DriverNo',`LMDT`='$curr_date_time',`transporter_name`='$TransporterName',`plant`='$Plant'   where `id`='$the_id'";
