...
Please find your lottery number: ".str_replace("'","",$lottery_no_set);
...
//echo $lipl_return_val;
	$sqlupdatescheme="UPDATE $consumer_scheme SET lottery_no='".str_replace("'","",$lottery_no_set)."' WHERE `trans_id`='$trans_id'";
