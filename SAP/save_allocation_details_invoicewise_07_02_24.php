...
$sqlin = "insert into $allocation_details (`date_and_time`,`order_id`,`APPORDERNO`,`inv_no`,`customer_id`,`sub_dealer_id`,`prod_desc`,`inv_date`,`inv_qty`,`allocation_qty`) values('$allocation_date_time','$order_id','$APPORDERNO','$inv_no','$customer_id','$sub_dealer_id','$prod_desc','$inv_date','$inv_qty','$qty')";
// echo $sqlin;
