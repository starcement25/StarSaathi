...
if($the_customer_code!=''){
	...
	$sqlbranchcode="SELECT dns_branch_code FROM $branch_master WHERE branch_code IN(SELECT branch_code FROM $customer_master WHERE  customer_code='".$the_customer_code."')";
