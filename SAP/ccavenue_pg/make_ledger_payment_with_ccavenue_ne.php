...
$card_type_option_arr["creditcard"] = "CRDC";
$card_type_option_arr["debitcard"] = "DBCRD";
$card_type_option_arr["netbanking"] = "NBK";
$card_type_option_arr["upi"] = "UPI";
...
$order_param_data["redirect_url"] = "https://www.starsaathi.com/SAP/ccavenue_pg/the_success_url_ne.php";
$order_param_data["cancel_url"] = "https://www.starsaathi.com/SAP/ccavenue_pg/the_cancel_url_ne.php";
...
if($payment_by!=""){
	...
	/*if(array_key_exists($payment_by,$card_type_option_arr)){
		$card_type_val = $card_type_option_arr[$payment_by];
		$order_param_data["card_type"] = $card_type_val;
		if($card_type_val=="UPI"){
		$order_param_data["card_name"] = "UPI";
		}else if($card_type_val=="DBCRD"){
		$order_param_data["card_name"] = "ICICI Bank";
		}else if($card_type_val=="NBK"){
		$order_param_data["card_name"] = "State Bank of India";
		}
	}*/
