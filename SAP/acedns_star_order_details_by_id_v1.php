    ...
    if ($totall > 0) {
        ...
        foreach ($all_rows as $row11) {
            ...
            if ($the_actual_ord_id != "") {
                ...
                if ($totall2 > 0) {
                    while ($row1 = mysql_fetch_assoc($resall2)) {
                        ...
                        $order_invoice_data[] = array(
                            "ch_uid"            => $ch_uid,
                            "apporderno"        => $apporder_no_chtl,
                            "erporderno"        => $erporder_no_chtl,
                            "challanno"         => $challanno_chtl,
                            "invno"             => $INVNO,
                            "invdt"             => $INVDT,
                            "prod_display_name" => $prod_display_name_chtl,
                            "invqty"            => $INVQTY,
                            "customer_code"     => $customer_code,
                            "truckno"           => $TRUCKNO,
                            "driverno"          => $ch_driverno,
            ...
            $order_data[] = array(
                ...
                "remarks"                        => $remarks,
                "order_invoice_data"             => $order_invoice_data,
                "plant"                          => $plant_name    // ✅ added at end
            );
        }
