...
@section('main_container')
  ...
  @php
    $routcode=str_replace('/', '',$routedetails[0]->route_code);
  @endphp
    <!-- page content -->
    <div class="right_col" role="main">
      ...
      <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    {{ Form::open(array('url' => 'route/'.$routcode,'class'=>'form-signin','method' => 'PUT')) }}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          {{ Form::text('route_name', $routedetails[0]->route_name, array(
                              'class' => 'form-control',
                              'id' => '',
