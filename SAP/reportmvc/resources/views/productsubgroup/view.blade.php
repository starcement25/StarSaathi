...
@section('main_container')
    ...
    <div class="right_col" role="main">
      ...
      <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Product Sub Group Details</h2>
                    ...
                    <br>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                                       {{$productsubgroupdetails[0]->dns_product_sub_group_code}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                                       {{$productsubgroupdetails[0]->product_group_code}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                                       {{$productsubgroupdetails[0]->product_sub_group_name}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                                       {{$productsubgroupdetails[0]->vertical_value}}
