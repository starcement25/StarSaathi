                 ...
                 <div class="x_panel">
                   <div class="col-md-3 col-sm-3 col-xs-2">
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-10">
                      {{ Form::open(array('url' => 'store/addsaudaformdetails','id'=>'createuser','class'=>'form-signin')) }}
                                                              ...
                                                              @foreach ($saudaformdetails as $key => $val)
                                                                ...
                                                                @endphp
                                                                 ...
                                                                 if($val->DataType=='enum')
                                                                   {
                                                                     ...
                                                                     {
                                                                 @endphp
                                                                 <input type="radio" name="{{$val->ColumnName}}" value="EX" @php if($val->Defaultvalue=='EX') { @endphp checked="" @php } @endphp> EX
                                                                 <input type="radio" name="{{$val->ColumnName}}" value="FOR" @php if($val->Defaultvalue=='FOR') { @endphp checked="" @php } @endphp> FOR
                                                                 ...
                                                                 @php
                                                                     ...
                                                                     {
                                                                  @endphp
                                                                  <input type="radio" name="{{$val->ColumnName}}" value="DIRECT" @php if($val->Defaultvalue=='DIRECT') { @endphp checked="" @php } @endphp> DIRECT
                                                                  <input type="radio" name="{{$val->ColumnName}}" value="BROKER" @php if($val->Defaultvalue=='BROKER') { @endphp checked="" @php } @endphp> BROKER
                                                                  <input type="radio" name="{{$val->ColumnName}}" value="BOTH" @php if($val->Defaultvalue=='BOTH') { @endphp checked="" @php } @endphp> BOTH
                                                                  @php
                                                                     }
                                                                     elseif($key=='10')
                                                                     {
                                                                  @endphp
                                                                  <input type="radio" name="{{$val->ColumnName}}" value="FACTORY" @php if($val->Defaultvalue=='FACTORY') { @endphp checked="" @php } @endphp> FACTORY
                                                                  <input type="radio" name="{{$val->ColumnName}}" value="DEPOT" @php if($val->Defaultvalue=='DEPOT') { @endphp checked="" @php } @endphp> DEPOT
                                                                  <input type="radio" name="{{$val->ColumnName}}" value="BOTH" @php if($val->Defaultvalue=='BOTH') { @endphp checked="" @php } @endphp> BOTH
                                                                  @php
                                                                     }
                                                                     else
