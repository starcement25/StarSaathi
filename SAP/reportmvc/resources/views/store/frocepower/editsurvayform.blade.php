                 ...
                 <div class="x_panel">
                   <div class="col-md-3 col-sm-3 col-xs-2">
                      <div class="row form-group">
                            <div class="col-xs-12">
                              <div class="list-group list-cust">
                                    ...
                                    <a href="#" class="list-group-item active">Survey Form Details</a>
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-10">
                      {{ Form::open(array('url' => 'store/editsurvayformdetails/'.$storesurvayform->user_id,'id'=>'createuser','class'=>'form-signin','files'=>'true','method'=>'patch')) }}
                                              ...
                                              <div class="row clearfix">
                          		                    <div class="col-md-12 column">
                          			                       <table class="table table-bordered table-hover" id="tab_logic">
                                                              ...
                                                              ?>
                                                              @foreach ($survayformdetails as $key => $val)
                                                    					<tr>
                                                                @php
                                                                $excludearraylist=array('0','1','2','16');
                                                                ...
                                                                @endphp
                                                                 ...
                                                                 if($val->DataType=='varchar' || $val->DataType=='int')
                                                                 {
                                                                  ...
                                                                  @endphp
                                                                  {{ Form::text($val->ColumnName, $storesurvayform->$colname, array(
                                                                      'class' => 'form-control',
                                                                      'id' =>$val->ColumnName,
                                                                  ...
                                                                  @php
                                                                   ...
                                                                   {
                                                                 @endphp
                                                                 <input type="radio" name="{{$val->ColumnName}}" value="yes" @php if($storesurvayform->$colname=='yes') { @endphp checked="" @php } @endphp> Yes
                                                                 <input type="radio" name="{{$val->ColumnName}}" value="no" @php if($storesurvayform->$colname=='no') { @endphp checked="" @php } @endphp> No
                                                                 @php
                                                                   }
                                                                   elseif($val->DataType=='text'){
                                                                 @endphp

                                                                    {{ Form::textarea($val->ColumnName, $storesurvayform->$colname, array(
                                                                        'class' => 'form-control',
                                                                        'id' =>$val->ColumnName,
                                                                        'placeholder' =>$val->ColumnName,
                                                                    )) }}
