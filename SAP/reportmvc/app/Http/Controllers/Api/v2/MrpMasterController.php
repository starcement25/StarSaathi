...
class MrpMasterController extends Controller
{
  ...
  public function mrpmasterincremental(Request $request){
    ...
    if($isverify==1){
      ...
      $url = url('/api/v2/mrpmaster?nick_name='.$nick_name.'&emp_code='.$emp_code.'&last_update_time='.$last_update_time.'&data_download_time='.$data_download_time.'&incremental_download='.$incremental_download);
