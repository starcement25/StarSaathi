<?php
	...
	$sqlcustomerSAP="SELECT KUNNR,ALTKN,NAME1,NAME2,NAME3,STRAS,STREET1,STREET2,STREET3,ORT01,ORT02,PSTLZ,TELF2,
					CREDIT_LIMIT,SMTP_ADDR,VKGRP,KDGRP,PAN_NUMBER,MIN_STOCK_QTY,ACCOUNT_NO,CITY2,COUNTER_POT,ZZONE,LZONE,VTEXT,`SEARCH_TERM2`,AUFSD,`REGION`,`ADDITIONAL_DATA2`,`TRANSZONE`,`SEARCH_TERM1` 
	...
	foreach($dns_customer_code_array as $dns_customer_code_val){
			...
			if($cust_type!='07' && $cust_type!='08' && $cust_type!='09' && $cust_type!='21' && $cust_type!='22' && $cust_type!='12' && $cust_type!='13')
			{
			...
			else
			{
				...
				|| $bank_account_number_db!=$bank_account_number || $monthly_potential_db!=$monthly_potential || $zone_db!=$zone || $region_db!=$region || $whatsapp_no_db!=$whatsapp_no) 
				{
