...
public final class LifitngAssignedModel
{
    ...
    private ArrayList<LiftingAssignModelChild>order_challan_data = new ArrayList<>();
    public ArrayList<LiftingAssignModelChild> getOrder_challan_data() {
        return order_challan_data;
    }
    public void setOrder_challan_data(final ArrayList<LiftingAssignModelChild> order_challan_data) {
