 ...
 * Created by @Amitabha
 */
public final class SubDealerLiftingApprovedRejectedAdapter_Date extends RecyclerView.Adapter
{
    ...
    public SubDealerLiftingApprovedRejectedAdapter_Date(final Context mContext, final List<LiftingModel> finalValues)
    {
