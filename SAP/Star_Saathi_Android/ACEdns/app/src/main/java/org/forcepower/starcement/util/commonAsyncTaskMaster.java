...
import org.forcepower.starcement.bean.EmployeeMasterDetails;
import org.forcepower.starcement.bean.EmployeeMenuAccess;
import org.forcepower.starcement.bean.EmployeeTargetAcheivement;
import org.forcepower.starcement.bean.MenuAccess;
...
import org.forcepower.starcement.bean.UserAccessDetails;
...
public final class commonAsyncTaskMaster
{
    ...
    private final String lastUpdate = "1971-01-01?10:10:10", dwnldDictTime = "1971-01-01?10:10:10",
                  mIsInCremental="no";
    ...
    public void _DOWNLOAD_customer_master()
    {
        try
        {
            ...
            print_log_d("Customer Details", "Saving " + noRows
                    + " records for \n Customer Details..");
            print_log_d("cstmr_er44f_err_498 ", customerList.size() + " ");
...
//                + "&user_type=" + get_user_type(mContext)
    ...
    private void Download_txt(String URL)
    {
        ...
        {
            URL = URL.replace(" ", "%20");
            print_log_d("amitabha2715_6417 ", status+"");
            print_log_d("Download_txt_6417 ", URL+"");
            ...
            try
            {
                ...
                e.printStackTrace();
                print_log_d("er44f_err_789 ", e.getMessage()+"");
