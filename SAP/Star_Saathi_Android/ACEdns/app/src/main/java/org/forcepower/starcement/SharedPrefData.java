...
public final class SharedPrefData
{
	...
	static final String SET_val_ligitng_JSON="SET_val_ligitng_JSON";
	...
	public static String getNotiLastDate(final Context ctx)
	{
		return getSharedPreferences(ctx).getString(SET_association_Key, "");
	}
	...
	public static String get_belong_dealer_dns_code(final Context ctx)
	{
		return getSharedPreferences(ctx).getString(SET_belong_dealer_dns_code, "");
	}
	...
	public static void set_lifting_json_data(final Context ctx, final String val)
	{
		final Editor editor = getSharedPreferences(ctx).edit();
		editor.putString(SET_val_ligitng_JSON, val);
		editor.apply();
	}
	public static String get_lifting_json_data(final Context ctx)
	{
		return getSharedPreferences(ctx).getString(SET_val_ligitng_JSON, "");
	}
//	public static void set_(final Context ctx, final String val)
//	{
//		final Editor editor = getSharedPreferences(ctx).edit();
//		editor.putString(SET_val, val);
//		editor.apply();
//	}
//	public static String get_(final Context ctx)
//	{
//		return getSharedPreferences(ctx).getString(SET_val, "");
//	}
}
