...
public final class Utils_
{
    ...
    public static long dateToMilliSecond_am_pm(String mDate)
    {
        long millis = 0;
        try
        {
            mDate = mDate.replaceAll("st|nd|rd|th", "");
            mDate = changeDateFormat("dd MMM yyyy HH:mm aaa", "dd MMM yyyy", mDate);
            //"29th May 2024 09:46 PM"
    ...
    public static long splConvertMilli_(String date)
    {
        long d = 0;
        try
        {
