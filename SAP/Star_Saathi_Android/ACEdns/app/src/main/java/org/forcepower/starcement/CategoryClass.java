...
public final class CategoryClass implements Serializable
{
	...
	public void set_order_status(String category_name) {
		this.category_name = category_name;
	}
	...
	public void set_order_full_date_time(String val) {
		this.order_full_date_time = val;
	}
	...
	public void set_freight(String val) {
		this.freight = val;
	}
	...
	public void set_destination_address(String val) {
		this.destination_address = val;
	}

	public String get_is_confirmed_material_received() {
		return is_confirmed_material_received;
	}
	public void set_is_confirmed_material_received(String val) {
		this.is_confirmed_material_received = val;
	}
