...
import static org.forcepower.starcement.constants.Constants.acedns_star_order_details_by_id;
...
import org.forcepower.starcement.adapter.ExpandableListAdapter;
...
public final class TrackOrderActivityNew extends AceDnsParentActivity
{
    ...
    public final class TRANS_GetOrderDetails_Asynctask extends AsyncTaskCoroutine<String, String>
    {
        ...
        public String doInBackground(final String... params)
        {
            ...
            if (HTTPUtils.isConnectionPossible(mContext))
            {
                try
                {
                    final String url = acedns_star_order_details_by_id;
                        ...
                        for(int i=0; i<ja.length(); i++)
                        {
                            ...
                            for(int j=0; j<jaChallan.length(); j++)
                            {
                                ...
                                starCementDB.insertChallan(
                                        ...
                                        eChallan.optString("challandt"),
                                        eChallan.optString("challanno"),
                                        eChallan.optString("challanqty"),
                                        ...
                                        eChallan.optString("is_confirmed_challan_material_received"),
                                        eChallan.optString("ch_uid"),
                                        eChallan.optString("transporter_name"),
        ...
        public void onPostExecute(String result)
        {
            ...
            try
            {
                ...
                //
                mAdapter = new ExpandableListAdapter(mContext_, catList);
