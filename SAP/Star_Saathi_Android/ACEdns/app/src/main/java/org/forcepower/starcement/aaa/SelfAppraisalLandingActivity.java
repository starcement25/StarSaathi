...
public final class SelfAppraisalLandingActivity extends AceDnsParentActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        try
        {
            ...
            ivHeaderForward = (ImageView) findViewById(R.id.ivHeaderForward);
            ...
            tvCurrYearLine = (TextView) findViewById(R.id.tvCurrYearLine);
            tvPreYearLine = (TextView) findViewById(R.id.tvPreYearLine);
            btnCurrentYear = (TextView) findViewById(R.id.btnCurrentYear);
            ...
            btnPreviousYear = (TextView) findViewById(R.id.btnPreviousYear);
            ...
            if(!(get_user_type(mContext).equalsIgnoreCase("broker")||
                    get_user_type(mContext).equalsIgnoreCase("dealer")))
            {
    ...
    //Achievement in GREEN, Target in BLUE, remove other colours
    ...
    private void show_clear_filter_dialog()
    {
        ...
        AlertDG.setNeutralButton("Clear Filter", new DialogInterface.OnClickListener() {
        ...
        AlertDG.setNegativeButton("Filter", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                try
                {
                    mAceDnsDatabase = new AceDnsDatabase(mContext);
