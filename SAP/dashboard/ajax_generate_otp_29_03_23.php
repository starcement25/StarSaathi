...
$sql1 = "select `dns_customer_code` from $customer_master where `dns_customer_code`='".$dealer_id."' and `phone_no`='".$mob_no."' and `cust_type`='Dealer' and `acedns` = 'Y'";
$res1 = mysql_query($sql1);
$totres1 = mysql_num_rows($res1);
if($totres1>0){
$sql1_upd = "update $customer_master set `sms_otp`='$otp_for_login' where `dns_customer_code`='".$dealer_id."' and `phone_no`='".$mob_no."'";
