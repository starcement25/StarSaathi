...
<body class="theme-red">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                             <?php if($_SESSION["logout_url"]!=''){ ?>
                            <li><a href="<?php echo $_SESSION["logout_url"]; ?>"><i class="material-icons">input</i>Sign Out</a></li>
                            <?php } else { ?>
                ...
                <ul class="list">
                    ...
                    if($_SESSION["sswa_user_type"]=="DEALER"){ ?>
                        ...
                        <span>Credit Note</span>
                         ...
                         <li <?php if($file_name=="customer_invoice_new.php"){ echo 'class="active"';}?>>
                        <a href="customer_invoice_new.php">
                        <i class="material-icons">layers</i>
                        <span>Invoice</span>
                        </a>
                        </li>

                        <li <?php if($file_name=="customer_invoice_new.php"){ echo 'class="active"';}?> style="display:none;">
                        <a href="customer_invoice_new.php">
                        <i class="material-icons">layers</i>
                        <span>Invoice New</span>
                        </a>
                        </li>
                        ...
                        <i class="material-icons">layers</i>
                        <span>Sub dealer Daily Transaction Details</span>
                        </a>
                        </li>
                        <li <?php if($file_name=="customer_ledger_scl_scln.php"){ echo 'class="active"';}?> >
                        <a href="customer_ledger_scl_scln.php">
                        <i class="material-icons">layers</i>
                        <span>Company wise Daily Transaction Details</span>
                        </a>
                        </li>
                        <li <?php if($file_name=="LiftingFinalFileUpload.php"){ echo 'class="active"';}?> >
                        <a href="LiftingFinalFileUpload.php">
                        <i class="material-icons">layers</i>
                        <span>Approved RSSD Lifting</span>
                        </a>
                        </li>
                        <li <?php if($file_name=="retailer_lifting.php"){ echo 'class="active"';}?>>
                        <a href="retailer_lifting.php">
                        <i class="material-icons">layers</i>
                        <span>Retailer Lifting</span>
                        </a>
                        </li>
                         <li <?php if($file_name=="allocation_monthwise.php"){ echo 'class="active"';}?>>
                        <a href="allocation_monthwise.php">
                        <i class="material-icons">layers</i>
                        <span>Allocated Lifting</span>
                        </a>
                        </li>
					...
					$sql1 = "select * from $menu_master where `menu_id` in(select `menu_id` from $selected_menu_for_user where `user_id`='$_SESSION[sswa_user_id]') AND is_active='yes' order by `menu_id` asc";
	...
	$the_menu_admin_page_sho = trim($row1["menu_admin_page"]);
        //sk add condition 06-01-26
        if($_SESSION["sswa_selected_cust_type"]=="RSSD" || $_SESSION["sswa_selected_cust_type"]=="Sub Dealer"){
            if($the_menu_name_sho=="Make Order" || $the_menu_name_sho=="Invoice" || $the_menu_name_sho=="Debit Note" || $the_menu_name_sho=="Credit Note" || $the_menu_name_sho=="Security Deposit Ledger" || $the_menu_name_sho=="Company wise Daily Transaction Details" || $the_menu_name_sho=="Retailer Lifting"  || $the_menu_name_sho=="Detailed Statement"){
                continue;
            }
        }
	?>
        ...
        <?php
        if(strtolower($the_menu_name_sho)=="invoice"){
		?>
        <li <?php if($file_name=="customer_invoice_new.php"){ echo 'class="active"';}?> style="display:none;">
                        <a href="customer_invoice_new.php">
                        <i class="material-icons">layers</i>
