...
$output = "<html><body><div  class=\"container\" style=\"width:100%;\"><img src=\"images/star-pdf-logo.jpeg\" alt=\"Star\" width=\"100px\" style=\"position:absolute; top:0px;\"/><h3 style=\"text-align:center;\">STAR CEMENT LIMITED</h3><h4 style=\"text-align:center;\">Debit Note Register</h4><p style=\"text-align:center;\">Period from ".$the_start_date." To ".$the_end_date."</p> <p><strong>Party Code</strong> : ".$the_customer_id." </p><p><strong>Party Name</strong> : ".$customer_name."</p><table style=\"width:100%; text-align:left;border:1px solid #333; \"><thead>
        ...
        <tr style=\"height: 50px;\">
          <th style=\"border-left: 1px solid #dee2e6; padding:5px; width:12%\"><b>GSTIN</b></th>
          ...
          <th style=\"border-left: 1px solid #dee2e6; padding:5px; width:7%\"><b>QTY</b></th>
          <th style=\"border-left: 1px solid #dee2e6; padding:5px; width:9%\"><b>BASIC</b></th>
          <th style=\"border-left: 1px solid #dee2e6; padding:5px; width:9%\"><b>CGST</b></th>
          <th style=\"border-left: 1px solid #dee2e6; padding:5px; width:9%\"><b>SGST</b></th>
          <th style=\"border-left: 1px solid #dee2e6; padding:5px; width:9%\"><b>IGST</b></th>
          <th style=\"border-left: 1px solid #dee2e6; padding:5px; width:8%\"><b>VAT/CST</b></th>
      ...
      <tbody>";
	$url_ck1 = 'https://starfiori.starcement.co.in:'.SRARFIORI_PORT_NO.'/sap/opu/odata/sap/YCP_SDN_CDS/YCP_SDN(p_Code=\''.$the_customer_id.'\',p_Frm=datetime\''.$the_start_date_time.'\',p_To=datetime\''.$the_end_date_time.'\')/Set?$format=json&sap-client=900';
...
if(count($app_results_arr)>0){
	foreach($app_results_arr as $app_results_aval){
		...
		$SGST,"IGST"=>$IGST,"TCS"=>$TCS,"ROFF"=>$ROFF,"AMOUNT"=>$AMOUNT);
	...
	foreach($debit_note_data as $debit_note_data_val)
	{
		...
		$output .= "<tr>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:12%\">".$GSTNO."</td>
          ...
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:7%\">".number_format($QTY,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:9%\">".number_format($BASIC,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:9%\">".number_format($CGST,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:9%\">".number_format($SGST,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:9%\">".number_format($IGST,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:8%\">".number_format($TCS,2)."</td>
          ...
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:10%\">".number_format($AMOUNT,2)."</td>
        </tr>";
 ...
 $output .= "<tfoot><tr>
          ...
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:12%\"></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:7%\"><b>".number_format($total_qty,2)."</b></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:9%\"><b>".number_format($total_basic,2)."</b></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:9%\"><b>".number_format($total_CGST,2)."</b></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:9%\"><b>".number_format($total_SGST,2)."</b></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:9%\"><b>".number_format($total_IGST,2)."</b></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px;text-align: right; width:8%\"><b>".number_format($total_TCS,2)."</b></td>
