...
<div class=\"container\" style=\"width:100%;\">
  ...
  <span style=\"width:40%; float:left;\">GSTIN: <strong>$VendGstin</strong><br />State: <strong>$VendState</strong><br />SO No: <strong>$DoNo</strong></span>
  <span style=\"width:60%; float:right;\">PIN No: <strong>$VendPin</strong><br/>State Code: <strong>$VendStCode</strong><br/>SO Dt: <strong>$DoDate_format</strong></span>
  </td>
