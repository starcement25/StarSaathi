...
if(count($app_results_arr)>0){
	...
	foreach($credit_note_data as $credit_note_data_val)
	{
		...
		$output .= "<tr>
          ...
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6;text-align: right; padding:5px; width:7%\">".number_format($QTY,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6;text-align: right; padding:5px; width:9%\">".number_format($BASIC,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6;text-align: right; padding:5px; width:9%\">".number_format($CGST,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6;text-align: right; padding:5px; width:9%\">".number_format($SGST,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6;text-align: right; padding:5px; width:9%\">".number_format($IGST,2)."</td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6;text-align: right; padding:5px; width:8%\">".number_format($TCS,2)."</td>
 ...
 $output .= "<tfoot><tr>
          ...
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:12%\"></td>
          <td style=\"border-top: 1px solid #dee2e6;border-left:1px solid #dee2e6; padding:5px; width:7%\"><b>".number_format($total_qty,2)."</b></td>
