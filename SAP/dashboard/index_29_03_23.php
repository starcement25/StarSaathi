...
<div class="msg" style="background-color:#ed2726; margin-top:10px;"><img style="text-align:center;" src="images/star_logo.jpg" width="150px"></div>
...
<div class="form-line">
<input type="text" class="form-control dealer_id" name="dealer_id" id="dealer_id" placeholder="Enter Dealer ID" autocomplete="off" required autofocus>
</div>
</div>
