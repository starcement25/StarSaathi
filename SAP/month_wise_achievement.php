...
$months[] = [
    ...
    'month_padded' => $current_date->format('m')
];
...
$months[] = [
    ...
    'month' => $prev_date->format('n'),
    'month_padded' => $prev_date->format('m')
];
...
while ($cust = mysql_fetch_assoc($res_cust)) {
    ...
    foreach ($months as $mdata) {
            ...
            $current_year  = $mdata['year'];
            $current_month = $mdata['month'];
            $month_padded  = $mdata['month_padded'];
