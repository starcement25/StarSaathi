...
$sub_dealer_cust_code = $_REQUEST["sub_dealer_cust_code"] ? addslashes(trim($_REQUEST["sub_dealer_cust_code"])) : "";
...
if ($sub_dealer_cust_code == "") {
	...
	$sql3 = "select * from $lifting_table where `sub_dealer_cust_code`='$sub_dealer_cust_code' and `status`='PENDING' $ym_qry order by `date_of_lifting` desc limit $start_from,$limit";
