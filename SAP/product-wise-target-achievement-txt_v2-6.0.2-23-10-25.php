...
//     ) AS month_number,
//     '$customer_id' AS sub_dealer_sap_code,
//     SUM(l.allocated_qty)  AS total_allocated_qty
...
while ($rowsappraisal = mysql_fetch_array($result)) {
    $month_number = sprintf("%02d", (int)$rowsappraisal['month_number']);
    // force numeric, but allow decimals
    $total_allocated_qty = (float)$rowsappraisal['total_allocated_qty']; 

    // optionally, if you want only 2 decimals:
    // $total_allocated_qty = number_format((float)$rowsappraisal['total_allocated_qty'], 2, '.', '');
		$emp_code=strtoupper($emp_code);
    $data .= "12001^STAR ANTIRUST CEMENT  TRADE^".$emp_code."^".$month_number."^0^".$total_allocated_qty."^0^0"."\n";
...
// 		$data = "12¥8
// 2025-09-05€12:21:03
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^01^0^0^2700^2707.75
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^02^0^0^3125^3759.5
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^03^0^0^3700^3934.75
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^04^3200^4085.5^0^3177
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^05^3100^3689.5^3000^3001
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^06^2600^2752.25^2350^2415.5
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^07^2300^2478.75^1870^2157
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^08^2500^2224^1760^2337.25
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^09^0^0^2200^1493.5
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^10^0^0^1476.523087^2164
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^11^0^0^2000^2097.5
// 12001^STAR ANTIRUST CEMENT  TRADE^C/0001261^12^0^0^2350^2491.5";
