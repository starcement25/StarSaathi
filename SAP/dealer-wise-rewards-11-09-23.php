...
{
// 	$sqlquery="SELECT * FROM $dealer_reward_status where customer_code='".$dns_customer_code."'";
...
// 	$count=mysql_num_rows($result);
	...
	// 	{
			...
			$reward_status_data[] = array("customer_code"=>$dns_customer_code,"reward_link"=>$reward_link);
