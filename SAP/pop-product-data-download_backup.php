...
if($the_customer_code!=''){
	...
	$sqlpopproduct="SELECT * FROM $pop_product_master WHERE `status`='Y' AND dns_prod_code IN(SELECT dns_prod_code FROM branch_pop_product  where branch_code='".$dns_branch_code."')";
