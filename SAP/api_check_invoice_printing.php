...
$title1 = "<b>2.Invoice Printing</b><br>";
...
$the_filter = '&$filter=(CustCo eq \'1000001497\' and ( InvoiceDt ge \'20230101\' and InvoiceDt le \'20230401\') )&sap-client=900';
echo $url_ck1 = 'https://PRDAPP1.starcement.co.in:44310/sap/opu/odata/sap/ZSD_CUSTOMER_BULK_INVOICE_SRV/ZSD_CUSTOMER_INVOICESet?$format=json'.str_replace(" ","%20",$the_filter);
