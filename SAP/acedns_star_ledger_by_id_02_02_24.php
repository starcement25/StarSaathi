...
$url_ck2 = 'https://starfiori.starcement.co.in:44300/sap/opu/odata/sap/ZFI_LEDGER_ODATA_SRV/LedgerSet?$format=json'.str_replace(" ","%20",$the_filter2);
...
$ledger_data[] = array("customer_code"=>$the_id,"dns_customer_code"=>$the_dealer_id,"voucher_date"=>$DocDate_format,"voucher_no"=>$VoucherNo,"quantity"=>$Menge,"amount_dr"=>$DrAmount,"amount_cr"=>$CrAmount,"balance"=>$balance,"narration"=>$BalText,"entry_date"=>$DocDate_format,"converted_voucher_date"=>$converted_voucher_date,"company_code"=>$Bukrs);
...
$ledger_balance_data = array("customer_code"=>$the_id,"dns_customer_code"=>$the_dealer_id,"the_customer_id"=>$the_customer_id,"balance"=>$credit_expose,"date"=>$date,"link"=>$link,"credit_limit"=>$credit_limit,"credit_expose"=>$credit_expose,"name1"=>$name1,"name2"=>$name2,"name3"=>$name3);
