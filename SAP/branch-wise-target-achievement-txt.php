...
FROM self_appraisal_branch_wise SBW, branch_master BM,employee_master EM WHERE SBW.branch_code = BM.branch_code AND EM.branch_code=BM.branch_code AND ".$emp_hierarchy_condition."";
