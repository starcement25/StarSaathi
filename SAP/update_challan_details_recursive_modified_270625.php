...
if($InvNo!=""){
	echo $sql1 = "SELECT `id`,`CHALLANNO` FROM $t_dochallan where `CHALLANNO`='$InvNo'";
	...
	echo $sql_clin = "insert into $t_dochallan (`ERPORDERNO`,`ERPORDERDT`,`SoTime`,`InvItem`,`CHALLANNO`,`CHALLANDT`,`InvTime`,`QTY`,`CHALLANQTY`,`TRUCKNO`,`DRIVERNO`,`LMDT`,`transporter_name`,`plant`) values ('$SoNo','$SoDate_format','$SoTime','$InvItem','$InvNo','$InvDate_format','$InvTime','$SoQty','${"InvQty".$InvNo}','$TruckNo','$DriverNo','$curr_date_time','$TransporterName','$Plant')";
