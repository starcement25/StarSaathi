...
$the_date_time =date('Y-m-d', strtotime("-$i days,$curr_date"))."T00:00:00";
//$the_date_time=$curr_date."T00:00:00";
//$the_date_time = "2023-02-01T00:00:00";
...
$starfiori_port_no = $GLOBALS['starfiori_port_no'];
	echo $url_ck1 = 'https://starfiori.starcement.co.in:'.$starfiori_port_no.'/sap/opu/odata/sap/ZSD_PARKLOT_SO_SERV_CDS/ZSD_PARKLOT_SO_SERV?$format=json'.str_replace(" ","%20",$the_filter);
