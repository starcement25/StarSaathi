...
$add_page_name = "customer_credit_limit_list.php";
$page_name = "customer_credit_limit_list.php";
$cnt = 0;
$countrow = 1;
...
$pgsql = "select $customer_master.`customer_code` from $customer_master INNER JOIN  $ledger_balance on $customer_master.`dns_customer_code`=$ledger_balance.`dns_customer_code` $new_whr_str";
...
jQuery(function () {
	...
	jQuery('.srch_reset_btn').on('click', function () {
		window.location = "customer_credit_limit_list.php";
	});
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>Customer Credit Limit (<?php echo $total_pgres;?>)&nbsp;&nbsp;
...
<span style="display:block; clear:both;"></span>
 <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
<?php
$sql1 = "select $customer_master.`customer_name`,$ledger_balance.dns_customer_code,$ledger_balance.credit_limit,$ledger_balance.current_balance,$ledger_balance.credit_days from $customer_master INNER JOIN  $ledger_balance on $customer_master.`dns_customer_code`=$ledger_balance.`dns_customer_code` $new_whr_str order by $customer_master.`customer_name` asc limit $start_from,$limit";
...
jQuery(function(){
	...
	jQuery(".srch_btn").click(function(){
		...
		window.location = "customer_credit_limit_list.php"+qstring;
		}else{
