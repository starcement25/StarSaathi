...
$whr_str .= "$aand ($customer_master.`dns_customer_code` like '%$search_array_val%' or $customer_master.`customer_name` like '%$search_array_val%' or $customer_master.`phone_no` like '%$search_array_val%' or $customer_master.`customer_id` like '%$search_array_val%' ) ";
...
$add_page_name = "edit_sub_dealer_list.php";
$page_name = "sub_dealer_list.php";
$cnt = 0;
$countrow = 1;
...
jQuery(function () {
	...
	jQuery('.srch_reset_btn').on('click', function () {
		window.location = "sub_dealer_list.php";
	});
...
jQuery(function(){
	...
	jQuery(".srch_btn").click(function(){
		...
		var qstring ="";
		var amp = "";
		if(srch_dlr_dtls!="" || sl_dlr_alocated_type!="" || sl_dlr_logedin_type!=""){
		if(srch_dlr_dtls!=""){
			if(qstring!=""){
		...
		window.location = "sub_dealer_list.php"+qstring;
		}else{
