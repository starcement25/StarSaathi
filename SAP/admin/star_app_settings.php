...
$submsg = "";
$add_page_name = "star_app_settings.php";
$page_name = "star_app_settings.php";
...
<tr>
<td><p>Enable registration button for IOS app</p>
<span class="small_msg"></span>
</td>
<td>
<?php
$is_show_reg_btn = $app_setting_key_arr["is_show_reg_btn"];
?>
<select class="form-control is_show_reg_btn" id="is_show_reg_btn">
<?php
foreach($reg_btn_option_arr as $reg_btn_option_arr_val){
?>
<option value="<?php echo $reg_btn_option_arr_val;?>" <?php if($reg_btn_option_arr_val==$is_show_reg_btn){?> selected="selected" <?php } ?>><?php echo $reg_btn_option_arr_val;?></option>
<?php } ?>
</select>

</td>
<td><a href="javascript:void(0);" class="btn bg-red waves-effect upd_is_show_reg_btn_btn the_float_btn">Update</a>
<span class="is_show_reg_btn_msg_ldr the_float_msg"></span>
<span class="span_clear"></span>
...
<tr>
<td><p>RSSD allocation days</p>
<span class="small_msg"></span>
</td>
<td>
<?php
$fetched_rssd_allocation_days = $app_setting_key_arr["rssd_allocation_days"];
?>
<input type='text'  class="form-control str_carry_forward_process_message" id="str_rssd_allocation_days" style="width:50%;" value="<?php echo $fetched_rssd_allocation_days;?>">
</td>
<td><a href="javascript:void(0);" class="btn bg-red waves-effect upd_str_rssd_allocation_days_btn the_float_btn">Update</a>
<span class="str_rssd_allocation_days_ldr the_float_msg"></span>
<span class="span_clear"></span>
...
jQuery(".upd_str_rssd_allocation_days_btn").click(function(){
var str_rssd_allocation_days = jQuery.trim(jQuery("#str_rssd_allocation_days").val());
jQuery(".str_rssd_allocation_days_ldr").html(img);
jQuery.ajax({
url: 'ajax_update_rssd_allocation_days.php',
type: 'post',
dataType: "json",
data:"str_rssd_allocation_days="+str_rssd_allocation_days,
success: function(response) {
if(response.process_sts=="YES"){
jQuery(".str_rssd_allocation_days_ldr").html(success_tik);
setTimeout(function(){
jQuery(".str_rssd_allocation_days_ldr").html("");
},5000);
}else{
jQuery(".str_rssd_allocation_days_ldr").html("");			
}
