...
// Get The Field Name
$slno_cnt = 1;
$output .= '"SL_No","APPORDERNO","Sale Order No","DATE","Branch_Name","Dealer SAP Code","Cust_Code","Customer_Name","Order_For_Type","Consignee SAP Code","Consignee_Name","Consignee_Address","Freight","Destination Code","Destination","Product_Name","qty(MT)","Unbooked_qty(MT)","Phone_No","Dump_Status","Dump_Code","Dump_Name","Dealer_Truck","STATUS","Order_From","Ref_SubDealer_Order","Authorized_By","Authorization_Date","Delivery point","Remarks text","Additional_data_1"';
$output .="\n";
