...
<div class="form-group">
<input type="hidden" name="pdf_form_submit" value="1"/>
<label class="Select Branch">Scheme Name<span class="estarix_cls">*</span><span class="branch_err_cls"></span></label>
<input style="border: 1px solid #ccc;" type="text" class="form-control"  id="scheme_name" name="scheme_name" placeholder="Scheme Name" require>
</div>
<div class="row clearfix">
