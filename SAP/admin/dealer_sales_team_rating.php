...
$page_name = "dealer_sales_team_rating.php";
$cnt = 0;
$countrow = 1;
...
$pgsql = "select $dealer_sales_team_visit_survey.*,$customer_master.`customer_name` from $dealer_sales_team_visit_survey left join $customer_master on $dealer_sales_team_visit_survey.`customer_code`=$customer_master.`dns_customer_code` where survey_rating!=''  $new_whr_str ";
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>Sales Visit Feedback List (<?php echo $total_pgres;?>) &nbsp;&nbsp;&nbsp;<span class="rpt_loader"></span> &nbsp;&nbsp;<a href="export_rating.php?get_type=all<?php echo $export_filtered_str;?>" class="btn bg-red waves-effe">Export&nbsp;Sales Visit Feedback&nbsp;List</a></h2>
    <div class="row clearfix">
    ...
    <div class="wrapper_scrl_div"></div>
                            ...
                            <div class="table-responsive table-container">  
                                <table class="table-bordered">
                                    ...
                                    <tbody>
<?php
$sql1 = "select $dealer_sales_team_visit_survey.*,$customer_master.`customer_name` from $dealer_sales_team_visit_survey left join $customer_master on $dealer_sales_team_visit_survey.`customer_code`=$customer_master.`dns_customer_code` where survey_rating!=''  $new_whr_str order by $dealer_sales_team_visit_survey.`sl_no` desc limit $start_from,$limit";
...
?>
<tr id="each_rating_tr_<?php echo $sl_no;?>">
<td><?php echo $the_sl_no;?></td>
<td><?php echo $customer_code;?></td>
<td><?php echo $sap_customer_code;?></td>
<td><?php echo $customer_name;?></td>
<td><?php echo $emp_name;?></td>
<td><?php echo $visit_datetime;?>
<td><?php echo $survey_rating;?></td>
<td><?php echo $remarks;?></td>
<td><?php echo $rating_update_datetime;?>
</tr>
<?php
$the_sl_no++;
	}
