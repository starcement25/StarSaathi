...
$survey_form = "survey_form_fy_21_22_23";
...
$add_page_name = "submitted_survey_list_fy_21_22_23.php";
$page_name = "submitted_survey_list_fy_21_22_23.php";
$cnt = 0;
$countrow = 1;
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>Survey FY 21,22,23 List (<?php echo $total_pgres;?>)&nbsp;&nbsp;
                          <a href="export_submitted_survey_list_fy_21_22_23.php" class="btn bg-red waves-effe">Export&nbsp;Survey&nbsp; FY 21,22,23&nbsp; List</a> &nbsp;
                          </h2>
                            <div class="row clearfix">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>is_return_fy21_22</th>
                                            <th>is_clmd_morthn_50k_tdstcs_fy22_23</th>
                                            <th>is_turnover_exceeds_10_crores_fy22_23</th>
                                            <th>PAN</th>
                                            <th>TAN</th>
                                            <th>Submitted&nbsp;On</th>
                                            <th>View&nbsp;PDF</th>
...
if($totres1>0){
	while($row1=mysql_fetch_assoc($res1)){
		...
		$sf_is_return_fy21_22 = $row1["sf_is_return_fy21_22"] ? trim($row1["sf_is_return_fy21_22"]) : "";
		
		
		$sf_is_clmd_morthn_50k_tdstcs_fy22_23 = $row1["sf_is_clmd_morthn_50k_tdstcs_fy22_23"] ? trim($row1["sf_is_clmd_morthn_50k_tdstcs_fy22_23"]) : "";
		$sf_is_turnover_exceeds_10_crores_fy22_23 = $row1["sf_is_turnover_exceeds_10_crores_fy22_23"] ? trim($row1["sf_is_turnover_exceeds_10_crores_fy22_23"]) : "";
		$sf_pan = $row1["sf_pan"] ? trim($row1["sf_pan"]) : "";
		$sf_tan = $row1["sf_tan"] ? trim($row1["sf_tan"]) : "";
...
<td><?php echo $sf_is_return_fy21_22;?></td>
<td><?php echo $sf_is_clmd_morthn_50k_tdstcs_fy22_23;?></td>
<td><?php echo $sf_is_turnover_exceeds_10_crores_fy22_23;?></td>
<td><?php echo $sf_pan;?></td>
<td><?php echo $sf_tan;?></td>
<td><?php echo $sf_submitted_datetime;?></td>
<td><a href="survey_pdf.php?the_id=<?php echo $sf_cust_code;?>" class="btn bg-red" target="_blank">VIEW PDF</a></td>
</tr>
<?php
	}
}else{
