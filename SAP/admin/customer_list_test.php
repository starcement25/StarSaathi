...
if($totres1>0){
	while($row1=mysql_fetch_assoc($res1)){
		...
		$sqlempmapping="SELECT EM.dns_emp_code,EM.emp_name FROM `customer_route_emp_relation` CRR, employee_master EM WHERE CRR.emp_code=EM.emp_code AND CRR.customer_code='".$customer_id."'  ORDER BY EM.emp_name ASC";
