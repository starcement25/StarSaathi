...
foreach($search_array as $search_array_key=>$search_array_val){
	...
	if($search_array_key=="month"){
		if($search_array_val!=''){
			$monthNumber = date('n', strtotime($search_array_val));
			/*if(trim($whr_str)!=""){
				$aand = " and";
			}else{
				$aand = "";
			...
			$aand = " and";
			$whr_str .= "$aand DATE_FORMAT(`date_of_lifting`, '%Y-%m')='$search_array_val' ";
...
$pgsql = "select `lid` from $lifting where `status`='APPROVED' $new_whr_str";
...
<span style="clear:both;display:block;"></span>
                ...
                <div class="row">
                    ...
                    <select class="form-control" id="sl_branch" name="sl_branch">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                        <input type="text" class="form-control" id="srch_linked_dealer" name="srch_linked_dealer" style="width:100%;" value="<?php echo $srch_linked_dealer;?>" placeholder="Search Linked Dealer Name" title="Search Linked Dealer Name">
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                        <input type="text" class="form-control" id="srch_sub_dealer" name="srch_sub_dealer" value="<?php echo $srch_sub_dealer;?>" placeholder="Search Sub Dealer / RSSD Name" title="Search Sub Dealer / RSSD Name">
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                        <?php 
                            /*$months = array(
...
<tbody>
<?php
$sql1 = "select * from $lifting WHERE `status`='APPROVED' $new_whr_str order by `lid` desc limit $start_from,$limit";
