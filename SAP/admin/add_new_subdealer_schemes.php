...
$branch_schemes_pdf = "subdealer_branch_schemes_PDF";
$branch_master = "branch_master";
$img_dir = "../schemes/";
$mime_type_array_pdf = array("application/pdf");


$add_page_name = "add_new_subdealer_schemes.php";
$page_name = "subdealer_schemes.php";
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                          <h2>ADD NEW SCHEME&nbsp;&nbsp;
                          <a href="<?php echo $page_name;?>" class="btn bg-red waves-effe">SHOW SUBDEALER SCHEME</a></h2>
                        </div>
                        <div class="body" style="padding:20px;">
<form action="upload_multiple_subdealer_schemes_pdf.php" method="post" onsubmit="return false;" enctype="multipart/form-data" id="multiple_upload_schemes_pdf_form" class="multiple_upload_schemes_pdf_form">
