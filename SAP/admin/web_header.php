...
<body class="theme-red">
            ...
            <div class="menu">
                ...
                <?php } else if($_SESSION["start_report_admin_name"]=='user3'){ ?>
                    ...
                    if($_SESSION["start_user_type"]=="MANAGER"){ ?>
                        <li <?php if($file_name=="order_list_invoice.php"){ echo 'class="active"';}?>>
                        <a href="order_list_invoice.php">
                        <i class="material-icons">layers</i>
                        <span>Order List</span>
                        </a>
                        </li>
						<li <?php if($file_name=="allocation_details_report.php"){ echo 'class="active"';}?> >
                        <a href="allocation_details_report.php">
                            <i class="material-icons">layers</i>
                            <span>Allocation Report</span>
                        </a>
                    </li>
					 <li <?php if($file_name=="allocation_details_report_invoicewise.php"){ echo 'class="active"';}?> >
                        <a href="allocation_details_report_invoicewise.php">
                            <i class="material-icons">layers</i>
                            <span>Allocation Report Invoicewise</span>
                        </a>
                    </li>
                    <li <?php if($file_name=="LiftingFinalFileUploadFilter.php"){ echo 'class="active"';}?>>
                        <a href="LiftingFinalFileUploadFilter.php" class="toggled waves-effect waves-block">
                            <i class="material-icons">layers</i>
                   ...
                   <?php ?> <li <?php if($file_name=="upload_fpx_dealer_data.php"){ echo 'class="active"';}?>>
                    ...
                    <li <?php if($file_name=="branch_wise_pg_status.php"){ echo 'class="active"';}?>>
					 ...
					 <li <?php if($file_name=="branch_wise_rssd_allocation_days.php"){ echo 'class="active"';}?> >
                        <a href="branch_wise_rssd_allocation_days.php">
                            <i class="material-icons">layers</i>
                            <span>Branch Wise Allocation Days</span>
                        </a>
                    </li>
					<li <?php if($file_name=="place_order_lifting_days.php"){ echo 'class="active"';}?> >
                        <a href="place_order_lifting_days.php">
                            <i class="material-icons">layers</i>
                            <span>Place Order Lifting Days</span>
                        </a>
                    </li>
					...
					<li <?php if($file_name=="place_order_query_list.php"){ echo 'class="active"';}?> >
                        <a href="place_order_query_list.php">
                            <i class="material-icons">layers</i>
                            <span>Order Query List</span>
                        </a>
                    </li>
					<li <?php if($file_name=="dealer_sales_team_rating.php"){ echo 'class="active"';}?> >
                        <a href="dealer_sales_team_rating.php">
                            <i class="material-icons">layers</i>
                            <span>Sales Visit Feedback</span>
                        </a>
                    </li>
					<li <?php if($file_name=="consumer_scheme_report.php"){ echo 'class="active"';}?> >
                        <a href="consumer_scheme_report.php">
                            <i class="material-icons">layers</i>
                            <span>Consumer Scheme Report</span>
                        </a>
                    </li>
					<li <?php if($file_name=="kismat_ki_bori_consumer_scheme_report.php"){ echo 'class="active"';}?> >
                        <a href="kismat_ki_bori_consumer_scheme_report.php">
                            <i class="material-icons">layers</i>
                            <span>Kismat Ki Bori Consumer Scheme Report</span>
                        </a>
                    </li>
					 <li <?php if($file_name=="branch_wise_consumer_scheme_status.php"){ echo 'class="active"';}?>>
                        <a href="branch_wise_consumer_scheme_status.php">
                            <i class="material-icons">layers</i>
                            <span>Branch Wise Consumer Scheme Status</span>
                        </a>
                    </li>
					 <li <?php if($file_name=="branch_wise_kismat_ki_bori_scheme_status.php"){ echo 'class="active"';}?>>
                        <a href="branch_wise_kismat_ki_bori_scheme_status.php">
                            <i class="material-icons">layers</i>
                            <span>Branch Wise Kismat Ki Bori Scheme Status</span>
                        </a>
                    </li>
                    <li <?php if($file_name=="LiftingFinalFileUpload.php"){ echo 'class="active"';}?>>
    ...
    if (isset($_SESSION['flash'])) {
        $type = $_SESSION['flash']['type'];     // e.g., 'success' or 'danger'
        $message = $_SESSION['flash']['message'];
        echo "

        <div id='popup-alert' class='alert alert-$type alert-dismissible' role='alert'>
