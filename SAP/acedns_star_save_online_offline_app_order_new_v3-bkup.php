...
$is_allow_order = "NO";
$process_message = "OS Restriction
Order not placed. Outstanding is more than 30 days. Please make payment.";
}
...
$is_allow_order = "NO";	
$process_message = "CL Restriction
Order not placed. Order amount is greater than available Credit Limit. Please make payment.";
}
}else{
$is_allow_order = "NO";		
}
