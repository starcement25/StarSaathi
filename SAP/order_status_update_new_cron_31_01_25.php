...
$prev_date_val = date('Y-m-d', strtotime("-15 days,$curr_date"));
...
$pn_text_msg = "";
	...
	$url_ck1 = 'https://starfiori.starcement.co.in:44300/sap/opu/odata/sap/ZSD_PARKLOT_SO_SERV_CDS/ZSD_PARKLOT_SO_SERV(\''.$the_app_ord_no.'\')?$format=json&sap-client=900';
