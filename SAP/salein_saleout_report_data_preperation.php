        ...
        while($rowbranch=mysql_fetch_array($resbranch))
        {
			...
			while($rowproduct=mysql_fetch_array($resproduct))
			{
				...
				{											
					...
					$res_insert_branch_product_stk=mysql_query($sql_insert_branch_product_stk) or die(mysql_error()." error
				...
				else
				{
					...
					$res_update_branch_product_stk=mysql_query($sql_update_branch_product_stk) or die(mysql_error()." error
			...
			while($rowproductgroup=mysql_fetch_array($resproductgroup))
			{
				...
				$res_insert_branch_product_group_stk=mysql_query($sql_insert_branch_product_group_stk) or die(mysql_error()." 
				...
				else
				{
					$sql_update_branch_product_group_stk="Update branch_product_group_wise_stock SET 
															...
															closing_stk='".${closing_stock.$product_group_code_product}."' 
															WHERE branch_code='".$branch_code."' AND product_group_code='".$product_group_code_product."'";
					$res_update_branch_product_group_stk=mysql_query($sql_update_branch_product_group_stk) or die(mysql_error()." 
