...
//$file_name='godown_tome_report_21st_Jan_2023_01_01_36_PM.csv';
if(count($to_email_arr)>0){
$mail             = new PHPMailer();
$bodyml             = $bodyml;
//$bodyml             = eregi_replace("[\]",'',$bodyml);
$mail->IsSMTP(); // telling the class to use SMTP
$mail->Host       = "mail.google.com"; // SMTP server (For gmail "mail.coral.in")
...
//$mail->addAttachment("csv/".$file_name);
...
$subject = "Test Subject STARSAATHI";
