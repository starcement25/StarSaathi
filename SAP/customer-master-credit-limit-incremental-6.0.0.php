...
$countbranches=mysql_num_rows($rsbranches);
 ...
 {
	 $sqlquery="SELECT DISTINCT c1.customer_code,c1.credit_limit FROM customer_master c1 WHERE ".$emp_hierarchy_condition." ".$login_condition."  ORDER BY c1.customer_name ASC"; 
 }
