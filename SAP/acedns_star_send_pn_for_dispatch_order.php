...
if($totres1>0){
	...
	$the_freight = $row1["freight"] ? trim($row1["freight"]) : "";
...
$the_pn_msg = "Dispatched - ".$the_challanqty." MT ".$the_prod_display_name." ".$the_destination_name." ".$the_freight." with Challan no: ".$the_challanno." dated ".$the_challandt.", Truck no: ".$the_truckno.", Driver Contact: ".$the_driverno;
