...
$url_ck1 = 'https://starfiori.starcement.co.in:44300/sap/opu/odata/sap/YVW_CPSDLEDGER_CDS/YVW_CPSDLEDGER(p_Code=\''.$the_customer_id.'\',p_Frm=datetime\''.$the_start_date_time.'\',p_To=datetime\''.$the_end_date_time.'\')/Set?$format=json&sap-client=900';
...
$ledger_data[] = array("customer_code"=>$the_id,"dns_customer_code"=>$SUBDEALERCODE,"voucher_date"=>$DOCDT_format,"voucher_no"=>$DOCNO,"amount"=>$AMOUNT,"narration"=>$NARRATION,"entry_date"=>$DOCDT_format);
...
$res_data = array("process_status"=>"YES","process_message"=>"$message","balance"=>$balance,"ledger_data"=>$ledger_data);
