...
$sql3 = "select *,DATE_FORMAT(`date_of_lifting`,'%Y-%m') as `ym_of_lifting` from $lifting_table where `sub_dealer_cust_code`='$sub_dealer_cust_code' and `status`='PENDING' $ym_qry order by `date_of_lifting` desc limit $start_from,$limit";
