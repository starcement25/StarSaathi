...
$title1 = "<b>Debit Note</b><br>";

//$url_ck1 = 'https://devqasapp.starcement.co.in:44301/sap/opu/odata/sap/ZSD_PARKLOT_SO_SERV_CDS/ZSD_PARKLOT_SO_SERV(\''.$did.'\')?$format=json&sap-client=300';

//$url_ck1 = 'https://prdapp1.starcement.co.in:44310/sap/opu/odata/sap/ZSD_PARKLOT_SO_SERV_CDS/ZSD_PARKLOT_SO_SERV(\''.$did.'\')?$format=json&sap-client=900';

//$the_filter = '&$filter=(InvDate eq datetime\''.$the_date.'\' and (InvTime ge time\''.$the_from_time.'\' and InvTime le time\''.$the_to_time.'\') )';
//$the_filter = "&(CustCo eq '1000002808' and ( InvoiceDt ge '20220801' and InvoiceDt le '20220810') )&sap-client=900";
/*https://PRDAPP1.starcement.co.in:44310/sap/opu/odata/sap/YCP_SCNDN_CDS/YCP_SCNDN(p_Code='1000002808',p_Frm=datetime'2022-08-01T00:00:00',p_To=datetime'2022-08-31T00:00:00')/Set?$format=json&sap-client=900*/
//https://devqasapp.starcement.co.in:44300/sap/opu/odata/sap/YCP_SDN_CDS/YCP_SDN(p_Code='1000000021',p_Frm=datetime'2022-01-01T00:00:00',p_To=datetime'2022-12-01T00:00:00')/Set?sap-client=150$format=xml
//https://PRDAPP1.starcement.co.in:44310/sap/opu/odata/sap/YCP_SDN_CDS/YCP_SDN(p_Code='1000000108',p_Frm=datetime'2022-01-01T00:00:00',p_To=datetime'2022-12-01T00:00:00')/Set?sap-client=150$format=xml
echo $url_ck1 = 'https://PRDAPP1.starcement.co.in:44310/sap/opu/odata/sap/YCP_SDN_CDS/YCP_SDN(p_Code=\'1000000812\',p_Frm=datetime\'2022-01-01T00:00:00\',p_To=datetime\'2023-01-01T00:00:00\')/Set?$format=json&sap-client=900';
