...
//$the_date_time =date('Y-m-d', strtotime("-$i days,$curr_date"));
$the_date_time=$curr_date."T00:00:00";
//$the_date_time = "2022-08-03T00:00:00";
$app_order_id_arr = array();
...
$the_filter = '&$filter=(erdat eq datetime\''.$the_date_time.'\'and status eq \'CANCEL\')';
	echo $url_ck1 = 'https://PRDAPP1.starcement.co.in:'.$starfiori_port_no.'/sap/opu/odata/sap/ZSD_PARKLOT_SO_SERV_CDS/ZSD_PARKLOT_SO_SERV?$format=json'.str_replace(" ","%20",$the_filter);
...
$sql_upd = "update $t_apperpdo set `STATUS`='Order canceled' where `APPORDERNO` in('".$app_order_ids_str."') ";
