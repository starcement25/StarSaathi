<?php
	...
	$sqlcustomerSAP="SELECT KUNNR,ALTKN,NAME1,NAME2,NAME3,STRAS,STREET1,STREET2,STREET3,ORT01,ORT02,PSTLZ,TELF2,
					CREDIT_LIMIT,SMTP_ADDR,VKGRP,KDGRP,PAN_NUMBER,MIN_STOCK_QTY,ACCOUNT_NO,CITY2,COUNTER_POT,ZZONE,LZONE,VTEXT,`SEARCH_TERM2`,AUFSD,`REGION`,`ADDITIONAL_DATA2` 
	...
	while($rowcustomerSAP=mysql_fetch_array($rscustomerSAP))
	{
		...
		if(!in_array($dns_customer_code,$dns_customer_code_array))
			...
			${whatsapp_no.$dns_customer_code}=$rowcustomerSAP['ADDITIONAL_DATA2'];
		}
