...
$sqlcust = "SELECT `customer_id` FROM $customer_master where `acedns`='Y' and cust_type='dealer' and customer_id='1000000150'";
...
if(count($app_results_arr)>0){
	foreach($app_results_arr as $app_results_aval){
		echo $InvoiceNo = $app_results_aval["InvoiceNo"];
