...
$to_date=$_REQUEST['to_date'];
 ...
 $url_ck1='https://starfiori.starcement.co.in:44300/sap/opu/odata/sap/ZFI_CREDIT_LIMIT_CDS/ZFI_Credit_limit(kunnr=\''.$customer_code.'\')?$format=json&sap-client=900';
...
if(count($app_results_arr)>0){
	...
	$balance=$total_CrAmount-$total_DrAmount;
	 ...
	 $res_data = array("process_status"=>"YES","process_message"=>"Success.","credit_limit"=>number_format($credit_limit,2),"credit_expose"=>number_format($credit_expose,2),"security_deposit"=>number_format($balance,2));
