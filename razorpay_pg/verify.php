...
if ($success === true)
{
$sql_update1_lgr = "update $ledger_transaction_table set `razorpay_payment_id`='$razorpay_payment_id',`razorpay_signature`='$razorpay_signature',`order_status`='Success' where `lt_order_id`='$shopping_order_id'";
