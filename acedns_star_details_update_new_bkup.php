...
if($totres1>0){
	...
	if($the_app_ord_no!="" && $the_erp_ord_no!=""){
		...
		if($totresck1>0){
			...
			if($challanno!=""){
			$sqlupd1 = "update $t_apperpdo set `STATUS`='Dispatched' where `id`='$the_id'";
			$resupd1 = mysql_query($sqlupd1);
			}else{
				$sqlupd1 = "update $t_apperpdo set `STATUS`='DO approved' where `id`='$the_id'";
				$resupd1 = mysql_query($sqlupd1);
			}
		}else{
			$sqlupd1 = "update $t_apperpdo set `STATUS`='DO approved' where `id`='$the_id'";
		...
		if($totresck1>0){
			...
			$resupd1 = mysql_query($sqlupd1);
				...
				$sqlupd1 = "update $t_apperpdo set `STATUS`='Order received' where `id`='$the_id'";
				$resupd1 = mysql_query($sqlupd1);
			}
		}else{
			$sqlupd1 = "update $t_apperpdo set `STATUS`='Order received' where `id`='$the_id'";
