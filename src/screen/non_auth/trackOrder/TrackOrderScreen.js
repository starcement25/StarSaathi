...
const TrackOrderScreen = (props) => {
    ...
    const requestForAppOrderList = async (url, page = 1) => {
        ...
        if (page === 1)
            ...
            setLoadingMore(true)
        try {
            const requestOptions = { method: "GET", redirect: "follow", headers: DataStorage.typeOfUse == 1 ? myHeaders : undefined }
        ...
        if (rawDate) {
            try {
                ...
                if (!isNaN(dateObj.getTime()))
                    formattedDate = dateObj.toLocaleDateString("en-GB", { day: "2-digit", month: "long", year: "numeric" })
                else
        ...
        return (
            <View style={{ width: "100%", paddingVertical: moderateScale(5), paddingHorizontal: moderateScale(10), gap: moderateScale(3), backgroundColor: DataStorage.transColorCode, borderTopWidth: moderateScale(1), borderColor: "#DCDDDF" }}>
                <View style={{ width: "100%", flexDirection: "row", alignItems: "center", }}>
                    ...
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> {invoiceNo} </Text>
                </View>
                <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
                    <Text style={{ color: "#7D7D7D", fontSize: moderateScale(13), width: moderateScale(120) }}>Invoice Date:</Text>
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> {invoiceDt || '-'} </Text>
                </View>
                {DataStorage.typeOfUse == 1 ? <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
                    ...
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> {(invoiceQty + ` ${item?.Unit}` || '-')} </Text>
                </View> : <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
                    <Text style={{ color: "#7D7D7D", fontSize: moderateScale(13), width: moderateScale(120) }}>{`Invoice QTY`}:</Text>
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> {(invoiceQty)} </Text>
                </View>}
                {DataStorage.typeOfUse == 1 && <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
                    <Text style={{ color: "#7D7D7D", fontSize: moderateScale(13), width: moderateScale(120) }}>Product Name:</Text>
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500", width: moderateScale(200) }} numberOfLines={2}> {(prodName || '-')} </Text>
                </View>}
                {DataStorage.typeOfUse == 1 && <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
                    <Text style={{ color: "#7D7D7D", fontSize: moderateScale(13), width: moderateScale(120) }}>Product Qty:</Text>
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500", width: moderateScale(200) }} numberOfLines={2}> {(Qty + " " + item?.zOrder_unit || '-')} </Text>
                </View>}
                <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
                    <Text style={{ color: "#7D7D7D", fontSize: moderateScale(13), width: moderateScale(120) }}>Truck No:</Text>
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> {truckNo} </Text>
                </View>
                <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
                ...
                {DataStorage.typeOfUse == 1 && <>
                    <View style={{ width: "100%", flexDirection: "row", alignItems: "center", marginTop: moderateScale(4) }}>
                        ...
                        <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> {plant || '-'} </Text>
                    </View>
                    <View style={{ width: "100%", flexDirection: "row", alignItems: "center", marginTop: moderateScale(2) }}>
                        ...
                        <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> {salesGroup || '-'} </Text>
                    </View>
                    <View style={{ width: "100%", flexDirection: "row", alignItems: "center", marginTop: moderateScale(2) }}>
                        <Text style={{ color: "#7D7D7D", fontSize: moderateScale(13), width: moderateScale(120) }}>Company:</Text>
                        <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> SSBSL </Text>
                    </View>
                </>}
            </View>
        )
                ...
                <View style={{ width: "100%", overflow: "hidden", borderWidth: moderateScale(1), borderColor: "#DCDDDF", borderRadius: moderateScale(10), backgroundColor: "white", elevation: 4, shadowColor: DataStorage.primaryColorCode, shadowRadius: moderateScale(20), shadowOffset: { x: 0, y: 4 } }}>
                    <TouchableOpacity activeOpacity={0.95} onPress={() => openCloseDetails(item, index)} style={{ width: "100%", padding: moderateScale(10), gap: moderateScale(3) }} >
                        <View style={{ width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "space-between", }}>
                            ...
                            </Text> : (item.erporderno && item.erporderno !== '' && <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> {item.erporderno} </Text>)}
                            <View style={{ flexDirection: "row", alignItems: "center", gap: moderateScale(10) }}>
                                <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> X {DataStorage.typeOfUse == 1 ? `${item.QTY || ''} ${item.UOM1 || ''}` : `${item.qty || ''} `} </Text>
                                <View style={{ paddingVertical: moderateScale(3), paddingHorizontal: moderateScale(10), borderRadius: moderateScale(10), backgroundColor: setColorCode(item) }}>
                                    <Text style={{ color: Colors.white, fontSize: moderateScale(12), textTransform: 'capitalize' }}> {DataStorage.typeOfUse == 1 ? (item.STATUS || '') : (item.status || '')} </Text>
                                </View>
                                {canShowDetails && <View style={{ width: moderateScale(20), height: moderateScale(20), borderWidth: moderateScale(1), borderColor: DataStorage.primaryColorCode, alignItems: "center", justifyContent: "center" }}>
                        ...
                        {DataStorage.typeOfUse == 1 ? (item.ERPORDERNO && item.ERPORDERNO !== '' && <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> {item.ERPORDERNO} </Text>) : null}
                        {appOrder ? <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> {item?.erporderno ?? ''} </Text> : null}
                        <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> {item.prod_display_name || ''} </Text>
                        {appOrder ? <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> {DataStorage.typeOfUse == 1 ? formatOrderDate(item.order_date) : (item.order_full_date_time || '')} </Text>
                            : <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> {DataStorage.typeOfUse == 1 ? formatOrderDate(item.order_date) : (item.erporderdt || '')} </Text>}
                        {appOrder ? <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Destination</Text> : {item.destination_address || ''} </Text>
                            : <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Destination</Text> : {item.destination_name || ''} </Text>}
                        <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Freight</Text> : {item.freight || ''} </Text>
                        {item.freight == 'FOR' ? <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Plant Name</Text> : {item.plant || ''} </Text>
                            : <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Dump Name</Text> : {item.plant || ''} </Text>}
                    </TouchableOpacity>
                    {item.isShowDetails && <FlatList
        ...
        return (
            <View style={{ paddingHorizontal: moderateScale(10), paddingVertical: moderateScale(7) }}>
                <View style={{ width: "100%", overflow: "hidden", borderWidth: moderateScale(1), borderColor: "#DCDDDF", borderRadius: moderateScale(10), backgroundColor: "white", elevation: 4, shadowColor: DataStorage.primaryColorCode, shadowRadius: moderateScale(20), shadowOffset: { x: 0, y: 4 } }}>
                    <TouchableOpacity activeOpacity={0.95} onPress={() => openCloseDetails(item, index)} style={{ width: "100%", padding: moderateScale(10), gap: moderateScale(3) }} >
                        <View style={{ width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                            <Text style={{ color: Colors.text, fontSize: moderateScale(14), fontWeight: "500" }}> {appOrder ? item?.APPORDERNO || '' : 'Sales order no : ' + item.ERPORDERNO} </Text>
                            <View style={{ flexDirection: "row", alignItems: "center", gap: moderateScale(10) }}>
                                <View style={{ paddingVertical: moderateScale(3), paddingHorizontal: moderateScale(10), borderRadius: moderateScale(10), backgroundColor: "#8FC031" }}>
                                    <Text style={{ color: Colors.white, fontSize: moderateScale(12), textTransform: 'capitalize' }}> {item?.STATUS || item?.status || ''} </Text>
                                </View>
                        ...
                        {appOrder & item?.ERPORDERNO ? <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> {item.ERPORDERNO} </Text> : null}
                        <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> {formatOrderDate(item?.order_date)} </Text>
                        <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Destination</Text> : {item?.destination_address || ''} </Text>
                        <Text style={{ color: Colors.text, fontSize: moderateScale(13), fontWeight: "500" }}> <Text style={{ fontWeight: '600' }}>Freight</Text> : {item?.freight || ''} </Text>
                        {item?.freight == 'FOR' ? <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Plant Name</Text> : {item?.plant || ''} </Text>
                            : <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Dump Name</Text> : {item?.plant || ''} </Text>}
                        {!appOrder && item.STATUS.toLowerCase() == 'dispatched' ? <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}> <Text style={{ fontWeight: '600' }}>Truck No.</Text> : {item?.truckNo || ''} </Text> : null}
                    </TouchableOpacity>
                    {(item && item.isShowDetails) && item?.order_invoice_data.length > 0 && <FlatList
                        data={item?.order_invoice_data}
    ...
    const renderFooter = () => {
        ...
        return (
            <View style={{ paddingVertical: moderateScale(20), alignItems: 'center' }}>
                ...
                <Text style={{ marginTop: moderateScale(8), color: Colors.text, fontSize: moderateScale(13) }}> Loading more orders... </Text>
            </View>
        )
    }
    ...
    return (
        <SafeView backgroundColor={Colors.white} bar={false} statusbarColor={Colors.main}>
                ...
                <View style={{ width: "100%", paddingHorizontal: moderateScale(15), paddingVertical: moderateScale(10), gap: moderateScale(5), flex: 1 }}>
                    <View style={{ width: "100%", alignItems: "flex-start", gap: moderateScale(10), marginBottom: moderateScale(10) }}>
                        ...
                        <View style={{ width: "100%", flexDirection: "row", alignItems: "center", gap: moderateScale(10) }}>
                            <TouchableOpacity activeOpacity={0.95} style={{ flex: 1 }} onPress={() => {
                                ...
                                <View style={{ flexDirection: "row", gap: moderateScale(10), alignItems: "center", width: "100%", borderWidth: moderateScale(1), borderColor: "#DCDDDF", borderRadius: moderateScale(10), padding: moderateScale(10) }}>
                                    ...
                                    <Text style={{ color: Colors.text, fontSize: moderateScale(14) }}> {startDate || 'Start Date'} </Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity activeOpacity={0.95} style={{ flex: 1 }} onPress={() => {
                                ...
                                <View style={{ flexDirection: "row", gap: moderateScale(10), alignItems: "center", width: "100%", borderWidth: moderateScale(1), borderColor: "#DCDDDF", borderRadius: moderateScale(10), padding: moderateScale(10) }}>
                                    <Image source={Icons.Calender} style={{ width: moderateScale(18), height: moderateScale(18), tintColor: DataStorage.primaryColorCode }} />
                                    <Text style={{ color: Colors.text, fontSize: moderateScale(14) }}> {endDate || 'End Date'} </Text>
                                </View>
                            </TouchableOpacity>
                    ...
                    <View style={{ width: "100%", flex: 1 }}>
                        <View style={{ width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
                            <TouchableOpacity activeOpacity={0.95} style={{ flex: 1 }} onPress={() => setAppOrder(true)}>
                                <View style={{ width: "100%", padding: moderateScale(10), alignItems: "center", justifyContent: "center", borderTopRightRadius: moderateScale(20), borderTopLeftRadius: moderateScale(20), backgroundColor: appOrder ? DataStorage.primaryColorCode : DataStorage.transColorCode, borderWidth: moderateScale(1), borderColor: "#DCDDDF" }}>
                                    <Text style={{ color: appOrder ? Colors.white : Colors.text, fontSize: moderateScale(14), fontWeight: "600" }}> App Order </Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity activeOpacity={0.95} style={{ flex: 1 }} onPress={() => setAppOrder(false)}>
                                <View style={{ width: "100%", padding: moderateScale(10), alignItems: "center", justifyContent: "center", borderTopRightRadius: moderateScale(20), borderTopLeftRadius: moderateScale(20), backgroundColor: !appOrder ? DataStorage.primaryColorCode : DataStorage.transColorCode, borderWidth: moderateScale(1), borderColor: "#DCDDDF" }}>
                                    <Text style={{ color: !appOrder ? Colors.white : Colors.text, fontSize: moderateScale(14), fontWeight: "600" }}> Offline Order </Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{ width: "100%", flex: 1, backgroundColor: "white", borderWidth: moderateScale(1), borderColor: "#DCDDDF" }}>
                            <FlatList
                                ...
                                ListEmptyComponent={() => (
                                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: moderateScale(50) }}>
                                        <Text style={{ color: Colors.text, fontSize: moderateScale(16), textAlign: 'center' }}> No orders found </Text>
                                    </View>
                                )}
                            ...
                            />
                            {DataStorage.typeOfUse == 1 && orderList.length > 0 && <View style={{ padding: moderateScale(10), backgroundColor: '#f0f0f0', borderTopWidth: 1, borderTopColor: '#DCDDDF' }}>
                                <Text style={{ color: Colors.text, fontSize: moderateScale(12), textAlign: 'center' }}> Page {currentPage} of {totalPages} | Showing {orderList.length} orders </Text>
                            </View>}
                        </View>
                    </View>
                </View>
            ...
            {isDateTimePicker && <View style={{ width: '100%', height: '100%', position: 'absolute', alignItems: 'center', justifyContent: 'center', backgroundColor: '#00000060' }}>
                <View style={{ backgroundColor: '#FFF', padding: 10, borderRadius: 10 }}>
                    <DateTimePicker value={datePickerType === 'start' ? startDateForPicker : endDateForPicker} mode="date" display="default" onChange={onChange} maximumDate={new Date()} />
                </View>
            </View>}
            {loading && <Loader />}
