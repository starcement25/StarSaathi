        ...
        <View style={{ paddingHorizontal: moderateScale(10), paddingVertical: moderateScale(7) }}>
            <View style={{ width: "100%", overflow: "hidden", borderWidth: moderateScale(1), padding: moderateScale(10), borderColor: "#DCDDDF", borderRadius: moderateScale(10), backgroundColor: "white", elevation: 4, shadowColor: DataStorage.primaryColorCode, shadowRadius: moderateScale(20), shadowOffset: { x: 0, y: 4 } }}>
                <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }}>
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), flex: 1.25 }}>
                        Dealer Name
                    </Text>
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}>
                        {":  "}
                    </Text>
                    <Text style={{ color: Colors.text, fontSize: moderateScale(13), flex: 2 }}>
                        {item.Dealer_Name || ''}
                    </Text>
                </View>
...
export default function DealerDeclarationHistoryScreen({ navigation }) {
    ...
    const requestForAllList = () => {
        ...
        console.log("https://starsaathi.com/SAP/dealer_exclusice_f2.php?customer_id=" + UrlStorage.ParameterList.BasicData.emp_id);
        
        fetch("https://starsaathi.com/SAP/dealer_exclusice_f2.php?customer_id=" + UrlStorage.ParameterList.BasicData.emp_id, requestOptions)
            ...
            <View style={{ flex: 1, flexDirection: 'column', padding: moderateScale(10) }}>
                {isFilter ? <>
                    <View>
                        ...
                        <TouchableOpacity
                            style={[styles.monthSelector, selectedYear ? styles.monthSelectorActive : null]}
                            onPress={() => setYearModalVisible(true)}
                            activeOpacity={0.7}
                        >
                            <Text style={selectedMonth ? styles.monthSelectorTextActive : styles.monthSelectorText}>
                                {" "}{selectedYear || "Tap to select year"}{" "}
                            </Text>
                    ...
                    <TouchableOpacity onPress={() => {
                        filterData()
                    }} activeOpacity={0.95} style={{ width: '100%', height: moderateScale(40), marginTop: moderateScale(10), borderRadius: moderateScale(10), backgroundColor: Colors.main, alignItems: 'center', justifyContent: 'center', }} >
                    ...
                    {isFilterData ? <View style={{ width: '100%', flexDirection: 'row-reverse', marginBottom: moderateScale(5) }}>
                        ...
                        <TouchableOpacity onPress={() => {
                            setStatus('pending')
                        }} activeOpacity={0.95} style={{ flex: 1, height: moderateScale(40), borderRadius: moderateScale(10), backgroundColor: status == 'pending' ? Colors.main : Colors.white, alignItems: 'center', justifyContent: 'center', elevation: 2, shadowColor: DataStorage.primaryColorCode, shadowRadius: moderateScale(20), shadowOffset: { x: (0), y: (4) } }} >
                            <Text style={{ color: status != 'pending' ? Colors.main : Colors.white, fontSize: moderateScale(14), fontWeight: '500' }}>
                                Pending
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => {
                            setStatus('approved')
                        }} activeOpacity={0.95} style={{ flex: 1, height: moderateScale(40), borderRadius: moderateScale(10), backgroundColor: status == 'approved' ? Colors.main : Colors.white, alignItems: 'center', justifyContent: 'center', elevation: 2, shadowColor: DataStorage.primaryColorCode, shadowRadius: moderateScale(20), shadowOffset: { x: (0), y: (4) } }} >
                            <Text style={{ color: status != 'approved' ? Colors.main : Colors.white, fontSize: moderateScale(14), fontWeight: '500' }}>
                                Approved
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => {
                            setStatus('rejected')
                        }} activeOpacity={0.95} style={{ flex: 1, height: moderateScale(40), borderRadius: moderateScale(10), backgroundColor: status == 'rejected' ? Colors.main : Colors.white, alignItems: 'center', justifyContent: 'center', elevation: 2, shadowColor: DataStorage.primaryColorCode, shadowRadius: moderateScale(20), shadowOffset: { x: (0), y: (4) } }} >
                            <Text style={{ color: status != 'rejected' ? Colors.main : Colors.white, fontSize: moderateScale(14), fontWeight: '500' }}>
                                Rejected
                            </Text>
                        </TouchableOpacity>
                    </View>}
