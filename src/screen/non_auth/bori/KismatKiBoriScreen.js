...
const MIN_QUANTITY = 10; // 👈 change this if required
  ...
  const updateCouponCode = (id, code) => {
    setCouponList(
      couponList.map((coupon) =>
        coupon.id === id ? { ...coupon, code } : coupon
      )
    );
  };
          ...
          <View style={styles.formContainer}>
            <View style={styles.fieldContainer}>
              <Text style={styles.fieldLabel}>
                House Owner Name <Text style={styles.required}>*</Text>
              </Text>
            ...
            <View style={styles.fieldContainer}>
              <Text style={styles.fieldLabel}>
                Date of Purchase <Text style={styles.required}>*</Text>
              </Text>
              <TouchableOpacity style={styles.datePickerContainer} onPress={showDatePickerModal} >
                <Text style={[styles.datePickerText, { color: isDateSelected ? "#333" : "#ccc" },]} >
                  {isDateSelected ? formatDate(dateOfPurchase) : "Select date"}
                </Text>
            ...
            <View style={styles.fieldContainer}>
              <Text style={styles.fieldLabel}>
                Quantity (in Bags) <Text style={styles.required}>*</Text>
              </Text>
              <View style={styles.inputContainer}>
                <TextInput
                  style={styles.textInput}
            ...
            <View style={styles.switchContainer}>
              ...
              <Switch
                ...
                trackColor={{ false: "#ccc", true: "#8FC031" }}
                thumbColor={couponGiven ? "#fff" : "#e9e9e9"}
              />
            </View>
            ...
            {couponGiven && (
              <View style={styles.couponSection}>
                <View style={styles.couponHeaderContainer}>
                  <Text style={styles.fieldLabel}>
                    Coupon Entry Section <Text style={styles.required}>*</Text>
                  </Text>
