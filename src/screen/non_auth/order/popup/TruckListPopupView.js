...
const TruckListPopupView = (props) => {
    ...
    return (
        <Modal isVisible={props.isVisible} style={{ margin: 0 }} customBackdrop={
            ...
            <View style={{ width: '100%', height: '100%', flexDirection: 'column' }}>
                ...
                <View style={{ width: "100%", height: '75%', backgroundColor: Colors.main, borderTopLeftRadius: moderateScale(20), borderTopRightRadius: moderateScale(20) }}>
                    <View style={{ width: "100%", padding: moderateScale(20), backgroundColor: "#E41B14", flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderTopLeftRadius: moderateScale(10), borderTopRightRadius: moderateScale(10) }}>
                        <Text style={{ color: "#FFFFFF", fontSize: moderateScale(16), fontWeight: "600" }}>Select Dealer Truck</Text>
                    </View>
                    <View style={{ padding: moderateScale(15), backgroundColor: "#fff" }}>
                        <TextInput placeholder="Search truck..." value={searchText} onChangeText={setSearchText} style={{ height: moderateScale(40), borderWidth: 1, borderColor: "#ccc", borderRadius: moderateScale(10), paddingHorizontal: moderateScale(10), fontSize: moderateScale(14), color: Colors.text }} />
                    </View>
                            ...
                            renderItem={({ item, index }) => (
                                <TouchableOpacity activeOpacity={0.95} onPress={() => props.selectItem(item)}>
                                    <View style={{ width: "100%", paddingHorizontal: moderateScale(20), paddingVertical: moderateScale(13), flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: (index % 2 !== 0 ? DataStorage.transColorCode : "#FFFFFF") }}>
                                        <Text style={{ color: Colors.text, fontSize: moderateScale(14), fontWeight: "500", textTransform: "uppercase" }}> {item} </Text>
                                    </View>
                                </TouchableOpacity>
                            )}
                            ListEmptyComponent={() => (
...
export default TruckListPopupView
