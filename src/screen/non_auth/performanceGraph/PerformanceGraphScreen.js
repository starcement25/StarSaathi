    ...
    return (
        <SafeView backgroundColor={Colors.white} bar={false} statusbarColor={Colors.main}>
            <View style={{ width: "100%", height: "100%", backgroundColor: Colors.white }}>
                <SBSCommonHeaderView title="Performance Graph" backPath=" " Filter={true} navigation={navigation} props={props} handlePerformanceFilterOpen={handleFilterPress} />
                {filterMode === 'single' && selectedYear && selectedMonth && <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: moderateScale(20), marginTop: moderateScale(10) }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#EEF4FF', borderRadius: moderateScale(20), paddingHorizontal: moderateScale(12), paddingVertical: moderateScale(5), borderWidth: 1, borderColor: '#C0D4F5', gap: moderateScale(6) }}>
                        <Text style={{ color: '#4A90E2', fontSize: moderateScale(12), fontWeight: '600' }}> {selectedYear.label}  ·  {selectedMonth.label} </Text>
                ...
                <View style={{ width: "100%", flex: 1, paddingHorizontal: moderateScale(20), paddingBottom: moderateScale(20) }}>
                    {!hideGraph ? <View style={{ flex: 1, backgroundColor: "#FFFFFF", borderWidth: moderateScale(1), borderColor: "#DCDDDF", padding: moderateScale(15), paddingStart: 0, marginTop: moderateScale(20), borderRadius: moderateScale(10), justifyContent: 'center' }}>
                    ...
                    </View> : <View style={{ flex: 1, borderWidth: moderateScale(1), borderColor: "#DCDDDF", borderRadius: moderateScale(10), justifyContent: 'center', alignItems: 'center' }}>
