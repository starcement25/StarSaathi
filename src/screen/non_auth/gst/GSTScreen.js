    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={() => { }} >
        <View style={styles.modalOverlay}>
            ...
            <View style={styles.modalCard}>
                ...
                <View style={{ width: '100%', marginTop: moderateScale(8) }}>
                    <Text style={styles.label}>{'Pan Number (if available)'}</Text>
                    <View style={styles.inputContainer}>
                        <TextInput
                            ...
                            onChangeText={onChangeMentionNamePanNo}
                        />
                        {!!panNoError && <Text style={styles.errorText}>{panNoError}</Text>}
                    </View>
                </View>
                <View style={styles.modalButtonRow}>
...
const GSTScreen = (props) => {
    ...
    const handleBackPressFormConfirmationPopup = () => {
        setShowGSTEntryPopup(true)
        setShowGSTConfirmationPopup(false)
    }
