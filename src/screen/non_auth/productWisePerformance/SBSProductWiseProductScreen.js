...
const SBSProductWiseProductScreen = (props) => {
    ...
    return (
        <SafeView backgroundColor={Colors.white} bar={false} statusbarColor={Colors.main}>
            <View style={{ flex: 1, backgroundColor: Colors.white }}>
                ...
                <View style={{ flex: 1, padding: moderateScale(20) }}>
                    <View style={{ flex: 1, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#DCDDDF", padding: moderateScale(15), paddingStart: 0, borderRadius: moderateScale(10), }}>
                        {barData.length > 0 ? <View style={{ width: '100%', overflow: 'hidden' }}>
                            <BarChart
                                data={barData}
                                barWidth={30}
                            ...
                            />
                        </View> : <Text style={{ color: '#000', flex: 1, textAlign: 'center', textAlignVertical: 'center' }}> {loading ? 'Loading...' : 'No data Found'} </Text>}
                    </View>
            ...
            <PerformanceFilterView isVisible={performanceFilterOpen} closeLoginPopup={closePerformanceFilter} />
            <PerformanceCalenderView isVisible={performanceCalendarOpen} closeLoginPopup={closePerformanceCalendar} onMonthSelect={handleMonthSelect} />
