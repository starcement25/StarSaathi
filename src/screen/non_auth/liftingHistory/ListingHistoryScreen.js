...
const ListingHistoryScreen = (props) => {
  ...
  //<-----pending lifting history - Cement----->
  ...
  //<-----Approved lifiting history - Cement---->
  ...
  //<-----Rejected lifting history - Cement------>
  ...
  return (
    <SafeView backgroundColor={Colors.white} bar={false} statusbarColor={Colors.main}>
                    ...
                    !loading && (
                      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: moderateScale(20) }}>
                        <Text style={{ color: Colors.text, fontSize: moderateScale(14) }}>
                          No {liftingStatus.toLowerCase()} records found
                        </Text>
                      </View>
                    )
                  )}
                      ...
                      <View style={{ width: "100%", overflow: "hidden", borderWidth: moderateScale(1), borderColor: "#DCDDDF", borderRadius: moderateScale(10), backgroundColor: "#FFFFFF", elevation: 10, shadowColor: DataStorage.primaryColorCode, shadowRadius: moderateScale(20), shadowOffset: { x: (0), y: (4) } }}>
                        <View style={{ width: "100%", padding: moderateScale(10), gap: moderateScale(6), }}>
                          <View style={{ width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center", gap: moderateScale(10) }}>
                              <View style={{ paddingVertical: moderateScale(3), paddingHorizontal: moderateScale(10), borderRadius: moderateScale(10), backgroundColor: "#C4B54433" }}>
                                <Text style={{ color: "#BFAF30", fontSize: moderateScale(12) }}>
                                  {liftingStatus}
                                </Text>
                              </View>
                            </View>
                          ...
                          <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}>
                            {item.dealer_name || 'Sati Trading co Dikom'}
                          </Text>
                          <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}>
                            {item.product_details || 'AAC Block 5000 Pcs.'}
                          </Text>
                          <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}>
                            {item.phone_number || '3000646365'}
                          </Text>
                          <Text style={{ color: Colors.text, fontSize: moderateScale(13) }}>
                            {item.created_date || '9th April 2025 06:34 AM'}
                          </Text>
                        </View>
                      </View>
                    </TouchableOpacity>
      ...
      <MonthYearPicker
        ...
        currentSelectedDate={selectedYearMonth}
        onClose={() => setMonthPickerVisible(false)}
        onConfirm={(date) => {
          setMonthPickerVisible(false);
          setSelectedYearMonth(date); // triggers API reload
        }}
      />
