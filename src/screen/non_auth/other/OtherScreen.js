      ...
      <View style={{ width: "100%", height: "100%", backgroundColor: Colors.white }} >
        ...
        <View style={{ width: "100%", flex: 1, padding: moderateScale(20) }}>
          {DataStorage.select_type_of_option == "t_and_c" ? (
            <Text style={{ fontSize: moderateScale(14), color: "#333" }}>
              {BasicStorage.t_and_c}
            </Text>
          ) : null}
          {DataStorage.select_type_of_option == "p_p_1" ? (
            <View style={{ flex: 1 }}>
              <WebView
                source={{ uri: "https://starsaathi.com/SAP/privacy.html" }}
                style={{ flex: 1 }}
                javaScriptEnabled
                domStorageEnabled
                startInLoadingState
          ...
          {DataStorage.select_type_of_option == "r_p" ? (
            <Text style={{ fontSize: moderateScale(14), color: "#333" }}>
              {BasicStorage.r_p}
            </Text>
          ) : null}
          {DataStorage.select_type_of_option == "t_and_c_1" ||
            DataStorage.select_type_of_option == "p_p" ||
            DataStorage.select_type_of_option == "r_p_1" ||
