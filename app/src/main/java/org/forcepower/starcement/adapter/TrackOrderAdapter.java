...
public final class TrackOrderAdapter extends BaseExpandableListAdapter
{
    private ArrayList<TrackOrderModelTop>off_data_list = new ArrayList<>();
    private Context ctx;

    public TrackOrderAdapter(final Context activity, final ArrayList<TrackOrderModelTop> off_data_list) {
        ...
        try
        {
            ...
            childViewHolder.tv_challan_feedback.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(det.getIs_confirmed_challan_material_received().equalsIgnoreCase("NO"))
                    {
                        final Intent intent = new Intent(ctx, MaterialRcvActivity.class);
                        intent.putExtra("apporderno",  det.getApporderno());
                        intent.putExtra("erporderno",  det.getErporderno());
                        intent.putExtra("ch_uid", det.getCh_uid());
                        intent.putExtra("challanno", det.getChallanno());

                        intent.putExtra("ch_quantity_no_of_bags", det.getCh_quantity_no_of_bags());
                        intent.putExtra("ch_status", det.getCh_status());
            ...
            childViewHolder.tvDate.setText(convertDate(det.getChallandt()));
                             ...
                             final View convertView, final ViewGroup parent)
    {
        ...
        try
        {
            ...
            groupName.setText(cat.getErporderno());
