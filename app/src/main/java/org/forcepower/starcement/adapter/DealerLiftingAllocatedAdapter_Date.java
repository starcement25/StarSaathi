 ...
 * Created by @Amitabha
 */
public final class DealerLiftingAllocatedAdapter_Date extends RecyclerView.Adapter {
    ...
    public final class MyViewHolder extends RecyclerView.ViewHolder {
        private final TextView tv_allo_prod_desc, tv_allocation_qty, tv_allo_date_and_time,
                tv_allo_counter_nm, tv_allo_challan_no, tv_allo_challan_date;
    ...
    public DealerLiftingAllocatedAdapter_Date(final Activity mContext, final List<AllocationListModel> finalValues) {
