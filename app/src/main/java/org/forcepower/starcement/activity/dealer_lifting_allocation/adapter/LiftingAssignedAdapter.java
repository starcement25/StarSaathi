package org.forcepower.starcement.activity.dealer_lifting_allocation.adapter;
...
public class LiftingAssignedAdapter extends BaseExpandableListAdapter {
    private ArrayList<LifitngAssignedDataSet>off_data_list = new ArrayList<>();
    private Activity ctx;
    private LiftingAllocationAssignedFragment dealerLiftingAssignedFragment;

    public LiftingAssignedAdapter(final Activity activity,
                                                final ArrayList<LifitngAssignedDataSet> off_data_list,
                                                final LiftingAllocationAssignedFragment dealerLiftingAssignedFragment) {
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        try
        {
            final LiftingAssignedChildDataSet det = off_data_list.get(groupPosition).getOrder_challan_data().get(childPosition);
            ...
            if(det.get_showDisAllocateButton())
            {
                ...
                childViewHolder.tv_dis_allocation.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final LifitngAssignedDataSet cat = off_data_list.get(groupPosition);
    ...
    public void setFilter(final ArrayList<LifitngAssignedDataSet> countryModels) {
