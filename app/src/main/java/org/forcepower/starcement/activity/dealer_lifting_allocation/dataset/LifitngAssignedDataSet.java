...
public class LifitngAssignedDataSet {
    ...
    private ArrayList<LiftingAssignedChildDataSet> order_challan_data = new ArrayList<>();
    public ArrayList<LiftingAssignedChildDataSet> getOrder_challan_data() {
        return order_challan_data;
    }
    public void setOrder_challan_data(final ArrayList<LiftingAssignedChildDataSet> order_challan_data) {
