...
$sql1 = "select `emp_code` from $changepassword order by `emp_code` asc";
...
if($emp_code!=""){
	...
	if($totres3>0){
		...
		if($totres4>0){
			...
			$sql2 = "update $changepassword set `customer_code`='$customer_code',`dns_customer_code`='$dns_customer_code' where `emp_code`='$emp_code'";
