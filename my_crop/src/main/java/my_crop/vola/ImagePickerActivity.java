...
//        }
    ...
    private void cropImage(Uri sourceUri) {
        File path = new File(getExternalCacheDir(), "gallery");
        if (!path.exists()) path.mkdirs();

        Uri destinationUri = Uri.fromFile(new File(path, queryName(getContentResolver(), sourceUri)));
...
//        options.setCircleDimmedLayer(true);
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.colorRed));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.colorRed_StatusBar));
//        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.colorRed));
    ...
    private static String queryName(final ContentResolver resolver, final Uri uri) {
        Cursor returnCursor =
