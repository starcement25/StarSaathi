...
if($get_fetch_type=="notloggedin"){
	...
	$where_qry = " where $customer_master.`acedns`='Y' and $customer_master.`cust_type`='Sub Dealer' and ($changepassword.`deviceid`='' or $changepassword.`deviceid` is null) ";

}else if($get_fetch_type=="loggedin"){

	$the_file_name = "loggedin_sub_dealer_".$curr_date.".csv";

	$where_qry = " where $customer_master.`acedns`='Y' and $customer_master.`cust_type`='Sub Dealer' and ($changepassword.`deviceid`!='' and $changepassword.`deviceid` is not null) ";
