...
$whr_str .= "$aand ($arc_consumer_reg.`name` like '%$search_array_val%' or $arc_consumer_reg.`mobile` like '%$search_array_val%' or $customer_master.`dns_customer_code` like '%$search_array_val%' or $customer_master.`customer_name` like '%$search_array_val%') ";
