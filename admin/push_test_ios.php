...
$pnres = "FALSE";
$keyfile = 'AuthKey_376WA9P52H.p8';               # <- Your AuthKey file
$keyid = '376WA9P52H';                            # <- Your Key ID
$teamid = '9HB6VQRP34';                           # <- Your Team ID (see Developer Portal)
...
$the_pn_msg = "123Test PN Message Star Saathi";
$nt_title = "123Test PN Title Star Saathi";
$the_m_image_link = "https://starsaathi.com/admin/images/logo.png";
$sent_sts_prod = pushNotificationInIOS("",$the_pn_msg,$nt_title,$reg_id,$the_m_image_link);
$sent_sts_dev = pushNotificationInIOS("development",$the_pn_msg,$nt_title,$reg_id,$the_m_image_link);

echo "<br>dev:".$sent_sts_dev;
echo "<br>prod:".$sent_sts_prod;
}else{
	echo "send reg_id";
}
