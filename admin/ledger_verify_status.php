...
<section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
              ...
              <a href="export_ledger_verify_data.php?get_type=all<?php echo $export_filtered_str;?>" class="btn bg-red waves-effe">Export&nbsp;Ledger&nbsp;Verify&nbsp;Data</a> &nbsp;<?php /*?> <a href="export_dealer.php?get_type=notloggedin" class="btn bg-red waves-effe">Export&nbsp;not&nbsp;loggedin&nbsp;dealer</a><?php */?>
                          </h2>
                            <div class="row clearfix">
...
<option value="2020" <?php if($astn_sl_year=="2020"){ ?> selected="selected" <?php }?> >2020</option>
</select>
    </div>
    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 add_top_bottom_padding">
    <label>Month</label>
