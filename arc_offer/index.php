...
<a href="arc_consumer_reg_history.php?login_user_id=<?php echo urlencode($login_user_id);?>&user_type=<?php echo $user_type;?>" class="btn btn-large btn-block btn-primary">REGISTRATION HISTORY</a>
<p style="text-align:center; font-size:12px; margin-top:10px;width:100%;">End Customer needs to lift minimum 60 bags ARC to be eligible for the above scheme during the scheme period. Terms & Conditions Apply. Prize images shown in the App are indicative only.
<br />
