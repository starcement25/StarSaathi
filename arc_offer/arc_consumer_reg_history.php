...
$add_page_name = "arc_consumer_reg_history.php";
$page_name = "arc_consumer_reg_history.php";
$is_show = "NO";
$show_message = "";
...
/*---------PAGINATION RELATED CODE START----------*/
$pgsql = "select `ac_id` from $arc_consumer_reg where `customer_code`='$login_user_id'";
...
<h5 style="text-align:center; margin-bottom:30px; margin-top:10px">REGISTRATION HISTORY</h5>
...
<span>Entry Date: <?php echo $entry_date;?></span><br/>
<span>Entry Time: <?php echo $entry_time;?></span><br/>
<span><strong>No. of bags(ARC):</strong> <?php echo $no_of_bags;?></span><span class="right_text <?php echo $sts_cls;?>"><strong><?php echo $each_status;?></strong></span></p>
