				...
				{ 
				  ...
				  //print_r($data);
					...
					else
					{
						...
						|| $incoterms_db!=$incoterms || $loadability_ton_db!=$loadability_ton || $transport_mode_db!=$transport_mode || $sauda_type_db!=$sauda_type)
						{
							if(($rds_code_val!='' && $customer_type!='D') || $customer_type=='D'){
							...
							$sqlupdated .= " $sqlupdaterdstag,visit_day='".addslashes($visit_day)."',
											...
											transport_mode='".$transport_mode."',sauda_type='".$sauda_type."',download_time=CURRENT_TIMESTAMP() 
