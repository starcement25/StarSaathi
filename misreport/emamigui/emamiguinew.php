...
if($_SESSION['admin_login']=="admin" || $_SESSION['admin_login']=="E0042" 
|| $_SESSION['admin_login']=="E0076" || $_SESSION['admin_login']=="supervisor" || $_SESSION['admin_login']=="system" 
...
function get_data_set($vertical,$date_condition,$emp_hierarchy_condition,$date_type){
	...
	if(strtoupper($_SESSION['nick_name']) == 'EMAMIT'){
		echo $sql_sauda_transaction_log;
		exit();
	}
...
<?php if($_SESSION['admin_login']=="E0042" || strtoupper($_SESSION['admin_login'])=="ED01" || strtoupper($_SESSION['admin_login'])=="GMHBC") { ?>
<div class="row">
...
<?php } if($_SESSION['admin_login']=="E0076" || strtoupper($_SESSION['admin_login'])=="GMSFATS") { ?>
<div class="row">
