...
?>
	...
	if($countcustomerroute>0){
		...
		while($row_customerroute = mysql_fetch_array($resultcustomerroute)){
			$sqltrans=mysql_fetch_array(mysql_query("SELECT * FROM CRM_transaction WHERE customer_code='".$row_customerroute['customer_code']."' AND SUBSTRING(call_id,-14,8)='".$today."'"));
