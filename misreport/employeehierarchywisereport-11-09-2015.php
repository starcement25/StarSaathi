   ...
   $cntemphierarchy=mysql_num_rows($rsemphierarchy);
	if($cntemphierarchy>0)
	{
		...
		while($rowemphierarchy=mysql_fetch_array($rsemphierarchy))
		{
		    ...
		    $res_emp_total_qty_MTD = mysql_query($sql_emp_total_qty_MTD);
		    $row_emp_total_qty_MTD = mysql_fetch_array($res_emp_total_qty_MTD);
		  ...
		  /* $sql_emp_total_qty_YTD = "SELECT sum(qty) as total_emp_booked_YTD FROM vertical_branch_employeewise_details WHERE 
		    ...
		    $res_emp_total_qty_YTD = mysql_query($sql_emp_total_qty_YTD);
		    $row_emp_total_qty_YTD = mysql_fetch_array($res_emp_total_qty_YTD);
