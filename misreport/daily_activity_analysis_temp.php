...
<body onLoad="GenericAjaxFunction('daily_activity_analysis_data_temp.php','display',0);">
<center>
...
function show_emp()
{
	...
	GenericAjaxFunction('daily_activity_analysis_data_temp.php?start_date='+start_date+'&end_date='+end_date,'display',0);
}
