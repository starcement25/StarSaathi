				...
				<tr>
                     <td class="menubar">
							...
							<tr>
								<td>
                                <?php
								 if(($_SESSION['designation'] == 'CRM') && strtoupper($_SESSION['nick_name']) == 'HALDIRAM'){
								?>
                                <a href="customer_allocation_CRM.php">Retailer CRM</a>
                                <?php
								}if(($_SESSION['designation'] == 'CRE') && strtoupper($_SESSION['nick_name']) == 'HALDIRAM'){
								?>
                                <a href="cre_verification_modified.php">Retailer CRE</a>
                                <?php
								}?>
                                </td>
