...
function show_datewise_data(){
	...
	document.getElementById("display_sub_details").innerHTML = '';
...
function show_next_level(page_href,prod_group_code,start_date,end_date,type,get_code,listing_type){
	...
	document.getElementById("display_details_toggle").innerHTML = "- Product Sub Group";
...
function show_sub_next_level(page_href,prod_sub_group_code,start_date,end_date,type,get_code,listing_type){
	document.getElementById("display_sub_details").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction(''+page_href+'?prod_sub_group_code='+prod_sub_group_code+'&start_date='+start_date+'&end_date='+end_date+'&type='+type+'&get_code='+get_code+'&listing_type='+listing_type,'display_sub_details',0);
	
	div_toggle('display_details','display_details_toggle','Product Sub Group');
	document.getElementById("display_sub_details_toggle").innerHTML = "- Product";
}

function PrintElem(elem)
{
	var display = document.getElementById('display').innerHTML;
	var display_details = document.getElementById('display_details').innerHTML;
	var display_sub_details = document.getElementById('display_sub_details').innerHTML;
	document.getElementById("display_total").innerHTML = display + display_details + display_sub_details;
	var displaydiv = document.getElementById("display_total").innerHTML;
	Popup(displaydiv);
}
...
function exporttocsv(divid)
{
	...
	var display_details = document.getElementById('display_details').innerHTML;
	var display_sub_details = document.getElementById('display_sub_details').innerHTML;
	//var displaydiv = display + display_details + display_sub_details;
	document.getElementById("display_total").innerHTML = display + '<br>' + display_details + '<br>' + display_sub_details;
	
	var table_div = document.getElementById('display_total');
	var table_html = table_div.outerHTML.replace(/ /g, '%20');
	a.href = data_type + ', ' + table_html;
	//setting the file name
	a.download = 'Productwise Sales Report' + postfix + '.xls';
...
function csvexport(admin_login,start_date,end_date,get_code,listing_type){
	window.open('productwise_sales_report_export.php?admin_login='+admin_login+'&start_date='+start_date+'&end_date='+end_date+'&get_code='+get_code+'&listing_type='+listing_type);
}

function pdffile(admin_login,start_date,end_date,get_code,listing_type){
//window.open('productwise_sales_report_pdf.php?admin_login='+admin_login+'&start_date='+start_date+'&end_date='+end_date);
...
function get_customerlist(type){
	...
	if(type == 'home'){
		window.location.href = 'productsubgroup_wise_sales_report.php';
	}
	else{
...
<table width="100%">
  <tr>
    ...
    <br>
    <p class="para_class"><span id="display_details_toggle" class="span_class" onClick="div_toggle('display_details','display_details_toggle','Product Sub Group');"></span></p>
    <div id="display_details" style="max-height: 480px; width:50%; overflow-y: scroll;" align="center"></div>
    <br />
    <p class="para_class"><span id="display_sub_details_toggle" class="span_class" onClick="div_toggle('display_sub_details','display_sub_details_toggle','Product');"></span></p>
    <div id="display_sub_details" style="max-height: 480px; width:50%; overflow-y: scroll;" align="center"></div>
    </div>
    </td>
  </tr>
</table>
