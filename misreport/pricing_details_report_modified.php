...
function show_saudawise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('pricing_details_data_modified.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('pricing_details_data_modified.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
}
</script>
<?php
