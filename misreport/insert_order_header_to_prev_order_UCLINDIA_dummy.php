...
mysql_query($sql_prev_order_del); 
...
while($row_order_header = mysql_fetch_array($res_order_header)){
	...
	$res_customer_type = mysql_query($sql_customer_type);
	$row_customer_type = mysql_fetch_array($res_customer_type);
	...
	if($order_check == 'O'){
		...
		$res_no_order_check = mysql_query($sql_no_order_check);
		$total_no_order_check = mysql_num_rows($res_no_order_check);
