...
if($type == 'designation'){
	...
	echo $sql_designation = "SELECT DISTINCT designation FROM employee_master WHERE hq IN (".$hq.")".$emp_hierarchy_condition_one." AND designation != '' ORDER BY designation ASC";
