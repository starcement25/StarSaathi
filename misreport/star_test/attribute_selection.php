...
function attribute_selection(){
	...
	$table_data = "<div id=\"display_data\"><table id=\"criteria_tab\" class=\"border\" width=\"35%\" style=\"border-collapse:collapse;border:1px solid #A92A61; padding:6px;\" >
	...
	if($zone_total>0){
		...
		$zone_select_control .= "<option value=\"".$zone_string."\">All</option>";
	...
	if($state_total>0){
		...
		if($zone_total>0){
			...
			while($row_state = mysql_fetch_array($res_state)){
				...
				$state_string .= "'".$state."',";
				$state_select_control .= "<option value=\"'".$state."'\">".$state."</option>";
			}
	...
	function state_branch(state){
		...
		document.getElementById("branch_select_div").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
		GenericAjaxFunction('get_state_related_data.php?state='+state+'&type=branch','branch_select_div',0);
	}
	...
	function branch_saleaccess(branch){
		...
		document.getElementById("saleaccess_select_div").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
		GenericAjaxFunction('get_branch_related_data.php?branch='+branch+'&type=sale_access','saleaccess_select_div',0);
	}
	...
	function saleaccess_emp(sale_access){
		...
		document.getElementById("emp_select_div").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
		GenericAjaxFunction('get_saleaccess_related_data.php?sale_access='+sale_access+'&branch='+branch+'&type=emp','emp_select_div',0);
	}
	...
	function hq_designation(hq){
		...
		document.getElementById("designation_select_div").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
		GenericAjaxFunction('get_hq_related_data.php?hq='+hq_one+'&type=designation','designation_select_div',0);
	}
	...
	function designation_emp(designation){
		...
		document.getElementById("emp_select_div").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
		GenericAjaxFunction('get_designation_related_data.php?zone='+zone+'&state='+state+'&hq='+hq+'&designation='+designation+'&type=emp','emp_select_div',0);
	}
