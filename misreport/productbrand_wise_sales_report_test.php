...
function show_datewise_data(){
	...
	document.getElementById("display_sub_sub_details").innerHTML = '';
	...
	document.getElementById("display_sub_sub_details_toggle").innerHTML = '';
...
function show_sub_next_level(page_href,prod_sub_group_code,start_date,end_date,type,get_code,listing_type){
	...
	document.getElementById("display_sub_details_toggle").innerHTML = "- Brand";
	
	if($('#display_sub_details').is(':visible')){
	}
	else{
		$('#display_sub_details').toggle(500);
	}
	
	document.getElementById("display_sub_sub_details_toggle").innerHTML = '';
}

function show_sub_sub_next_level(page_href,prod_brand_code,start_date,end_date,type,get_code,listing_type){
	document.getElementById("display_sub_sub_details").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction(''+page_href+'?prod_brand_code='+prod_brand_code+'&start_date='+start_date+'&end_date='+end_date+'&type='+type+'&get_code='+get_code+'&listing_type='+listing_type,'display_sub_sub_details',0);
	
	div_toggle('display_sub_details','display_sub_details_toggle','Brand');
	document.getElementById("display_sub_sub_details_toggle").innerHTML = "- Product";
}
...
function get_customerlist(type){
	...
	if(type == 'home'){
		window.location.href = 'productbrand_wise_sales_report.php';
	}
	else{
...
<table width="100%">
  <tr>
    ...
    <br />
    <p class="para_class"><span id="display_sub_details_toggle" class="span_class" onClick="div_toggle('display_sub_details','display_sub_details_toggle','Brand');"></span></p>
    <div id="display_sub_details" style="max-height: 480px; width:50%; overflow-y: scroll;" align="center"></div>
    <br />
    <p class="para_class"><span id="display_sub_sub_details_toggle" class="span_class" onClick="div_toggle('display_sub_sub_details','display_sub_sub_details_toggle','Product');"></span></p>
    <div id="display_sub_sub_details" style="max-height: 480px; width:50%; overflow-y: scroll;" align="center"></div>
    <br />
    </div>
    </td>
  </tr>
