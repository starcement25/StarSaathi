...
function main(){
	...
	function display_result(){
		...
		GenericAjaxFunction('admin_mis_order_register_data_test.php?employee='+employee,'display',0);
	...
	function view_details(val,employee,cust_type){
		...
		GenericAjaxFunction('admin_mis_order_register_details_test.php?val='+val+'&employee='+employee+'&cust_type='+cust_type,'display_details',0);
