				  ...
				  $data[]=$value;
					...
					if(providing_code == 'yes')
					{
						if($reporting_to!='')
						{
							...
							$res_check_emp_dns_code = mysql_query($sql_check_emp_dns_code);
							$total_rows_dns_emp_code = mysql_num_rows($res_check_emp_dns_code);
			...
			foreach($lines as $line)
			{
				...
				{ 
				  ...
				  //print_r($data);
					...
					$rsrouteempchk=mysql_query($sqlrouteempchk);
					$countrouteempchk=mysql_num_rows($rsrouteempchk);
					if($countrouteempchk<1 )
					{
						...
						mysql_query($sqlemproute) or  array_push($error_array,"mysql_error().Internal DATA execution problem on emp route relation table.PLease contact aceDNS admin.");
					}
