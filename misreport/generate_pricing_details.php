	...
	if($_REQUEST['pricing_mode']=='create_pricing')
	{
		...
		else
		{
			$sqlupdatepricingdetails="UPDATE pricing_detials 
									  ...
									  product_group_code='".$product_group_code."'";
			$rsupdatepricingdetails=mysql_query($sqlupdatepricingdetails);
		}*/
		 ...
		 {	
			...
			while($rowselectdistinctbranch=mysql_fetch_array($rsselectdistinctbranch))
			{
				...
				while($rowselectdistinctdnsprod=mysql_fetch_array($rsselectdistinctdnsprod))
				{
					...
					$rsdepotfreightcostprodwise=mysql_query($sqldepotfreightcostprodwise);
					$rowdepotfreightcostprodwise=mysql_fetch_array($rsdepotfreightcostprodwise);
