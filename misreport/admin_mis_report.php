...
function main(){
	...
	echo "<br>";
	?>
    <div id="display" style="max-height: 350px; max:100%; overflow-y: scroll; overflow-x: scroll;" align="center"></div><br />
	...
	function display_result(){
		...
		GenericAjaxFunction('admin_mis_report_data.php?employee='+employee,'display',0);
	...
	function show_KYC(val,employee){
		var employee = encodeURIComponent(employee);
		alert(employee);
	}
	
	function show_brand(val,employee){
		var employee = encodeURIComponent(employee);
		alert(employee);
	}
	
	function show_technical(val,employee){
		var employee = encodeURIComponent(employee);
		alert(employee);
	}
	
	function show_site_visit(val,employee){
		var employee = encodeURIComponent(employee);
		alert(employee);
	}
	
	function show_market_feedback(val,employee){
		var employee = encodeURIComponent(employee);
		alert(employee);
	}
