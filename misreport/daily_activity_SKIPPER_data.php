...
//if(!empty($date_array)){
	...
	while($row_emp = mysql_fetch_array($res_emp)){
		...
		if($customer_row_check>0){
			echo "<tr><td colspan = '10' class = 'TDHEAD_SUB' align = 'center'>$dns_emp_code - $emp_name</td></tr>";
			while($rowcustomercheck=mysql_fetch_array($rscustomercheck)){
				...
				$order_rows = mysql_num_rows($res_order_details);
						...
						${checkinout_remarks.$customer_code.$date_array_val.$emp_code}=$checkinout_remarks;
					  }
