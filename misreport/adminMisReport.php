    ...
    <tr class="TDHEAD" > 
     ...
     <tr class="TDHEAD_SUB"> 
        ...
        while($rowinformation=mysql_fetch_array($resinformation))
        {
			...
			|| strtoupper($_SESSION['nick_name'])=='LTS' || strtoupper($_SESSION['nick_name'])=='EMARK' || strtoupper($_SESSION['nick_name'])=='OJBH' || strtoupper($_SESSION['nick_name'])=='JPHARMA' || strtoupper($_SESSION['nick_name'])=='STAR' || strtoupper($_SESSION['nick_name'])=='MINU' || strtoupper($_SESSION['nick_name'])=='PARLE' || strtoupper($_SESSION['nick_name'])=='HALDIRAM' || strtoupper($_SESSION['nick_name'])=='SKIPPER' || strtoupper($_SESSION['nick_name'])=='SHYAM' || strtoupper($_SESSION['nick_name'])=='KHMER' || strtoupper($_SESSION['nick_name'])=='ARCHITA') 
			&& $mode=='T'){
