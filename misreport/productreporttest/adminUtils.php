						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							 ...
							 if($_SESSION['admin_login']!='' || strtolower(substr($_SESSION['admin_login'],0,1))=='c')
							{
								...
								<?php
									...
									else if(survey == 'yes' && strtoupper($_SESSION['nick_name']) != 'STAR' && strtoupper($_SESSION['nick_name']) != 'CASHLESS'){?>
									...
									else if(survey == 'yes' && strtoupper($_SESSION['nick_name']) == 'STAR' && $_SESSION['admin_login']!='emovesfa_hr'){?>
...
?>
                                ...
                                <td><?php if(($_SESSION['admin_login']=='admin' || strtolower($_SESSION['admin_login'])=='c0007') && ace_integration=='yes'){?><a href="adminCustomerAccess.php" name="link21" id="link21">Customer Access</a><?php }?></td>
                                 <td><?php if(($_SESSION['admin_login']=='admin' || strtolower($_SESSION['admin_login'])=='c0007') && ace_integration=='yes'){?><a href="adminProductAccess.php" name="link23" id="link23">Product Access</a><?php } else if(($_SESSION['admin_login']=='admin' || strtolower($_SESSION['admin_login'])=='c0007') && strtoupper($_SESSION['nick_name'])=='MAITHAN'){?><a href="adminProductAccess.php" name="link23" id="link23">Product Access</a><?php }?></td>
                                   <td><?php if(($_SESSION['admin_login']=='admin' && (strtoupper($_SESSION['nick_name'])!='RKBK' && strtoupper($_SESSION['nick_name'])!='EMAMI' && strtoupper($_SESSION['nick_name'])!='EMAMIT' && strtoupper($_SESSION['nick_name'])!='STORE') && strtoupper($_SESSION['nick_name'])!='LIPL' && strtoupper($_SESSION['nick_name'])!='STAR' && strtoupper($_SESSION['nick_name'])!='CASHLESS' && strtoupper($_SESSION['nick_name'])!='PARLE')|| (strtoupper($_SESSION['nick_name'])=='CDNS' && strtoupper($_SESSION['admin_login'])=='E0056')){?><a href="adminCustomerMapping.php" name="link25" id="link25">Customer Employee Relation</a><?php }?></td>
                                ...
                                <td>
                                <?php if($_SESSION['admin_login']!='' && (strtoupper($_SESSION['nick_name'])=='EMAMI' || strtoupper($_SESSION['nick_name'])=='EMAMIT')){?><a href="depotwise_pricelist_report.php" name="link29" id="link29" onMouseOver="MM_showMenu(window.mm_menu_0716141129_0,0,26,null,'link29')" onMouseOut="MM_startTimeout();">Pricelist</a><?php } ?>
                                </td>
                                ...
                                <? } ?>
                                   ...
                                   <td><?php if(($_SESSION['admin_login']=='admin' || $_SESSION['admin_login']=='c0007') && (strtoupper($_SESSION['nick_name'])=='MDPL' || 
									...
									strtoupper($_SESSION['nick_name'])=='STORE' || strtoupper($_SESSION['nick_name'])=='LIPL' || strtoupper($_SESSION['nick_name'])=='RUPA' || strtoupper($_SESSION['nick_name'])=='RUPAT' || strtoupper($_SESSION['nick_name'])=='KFPL' || strtoupper($_SESSION['nick_name'])=='MINU' || strtoupper($_SESSION['nick_name'])=='JPHARMA' || strtoupper($_SESSION['nick_name'])=='EMARK' || strtoupper($_SESSION['nick_name'])=='TT' || strtoupper($_SESSION['nick_name'])=='STAR' || strtoupper($_SESSION['nick_name'])=='EGEN' || strtoupper($_SESSION['nick_name'])=='CASHLESS' || strtoupper($_SESSION['nick_name'])=='PARLE' || strtoupper($_SESSION['nick_name'])=='RKBK' || strtoupper($_SESSION['nick_name'])=='YELLOWSTR') || strtoupper($_SESSION['nick_name'])=='ABDOS' || strtoupper($_SESSION['nick_name'])=='SANICO' || strtoupper($_SESSION['nick_name'])=='GLOSTER' || strtoupper($_SESSION['nick_name'])=='VIPL' || strtoupper($_SESSION['nick_name'])=='JASWANI' || strtoupper($_SESSION['nick_name'])=='KUNJSALE' || strtoupper($_SESSION['nick_name'])=='CDNS' || strtoupper($_SESSION['nick_name'])=='SHAKERS' || strtoupper($_SESSION['nick_name'])=='ROUNAK' || strtoupper($_SESSION['nick_name'])=='MAITHAN' || strtoupper($_SESSION['nick_name'])=='DAKSH' || strtoupper($_SESSION['nick_name'])=='MAX' || strtoupper($_SESSION['nick_name'])=='SWETA' || strtoupper($_SESSION['nick_name'])=='HALDIRAM' || strtoupper($_SESSION['nick_name'])=='KFTPL' || strtoupper($_SESSION['nick_name'])=='DNV'){ if(sauda_allocation == 'no' && sale=='no'){?><a href="adminCsvReadIncremental.php" name="link26" id="link26">Upload Data</a><?php }else if(sauda_allocation == 'no' && sale=='yes'){?><a href="adminCsvReadIncrementalSalePurchase.php" name="link26" id="link26">Upload Data</a><?php }
									else if(sauda_outstanding == 'yes'){ ?><a href="adminCsvReadIncrementalSauda.php" name="link43" id="link43" onMouseOver="MM_showMenu(window.mm_menu_0716141743_0,0,26,null,'link43')" onMouseOut="MM_startTimeout();">Upload Data</a><?php } }?>
                                   </td>
                                ...
                                <td><?php if($_SESSION['admin_login']!='' && ( strtoupper($_SESSION['nick_name'])!='RKBK' && strtoupper($_SESSION['nick_name'])!='RKBKT') || $_SESSION['admin_login'] == 'supervisor'){ if(sauda_allocation == 'no' && survey=='no' && strtoupper($_SESSION['nick_name'])!='PARLE'){?><a href="adminMonthlyAttendencePrint.php" name="link19" id="link19" onMouseOver="MM_showMenu(window.mm_menu_0716141733_0,0,26,null,'link19')" onMouseOut="MM_startTimeout();">Download Data</a><?php
								}
								...
								&& $_SESSION['admin_login']!='emovesfa_hr'){?>
								...
								<?php } 
							    else if(sauda_allocation == 'no' && survey=='yes' && $_SESSION['admin_login']!='emovesfa_hr' && strtoupper($_SESSION['nick_name'])!='CASHLESS'){?>
                                <a href="exceldownloadSurvey.php" name="link31" id="link31" onMouseOver="MM_showMenu(window.mm_menu_0716141731_0,0,26,null,'link31')" onMouseOut="MM_startTimeout();">Transaction Download</a>
								<?php }
								...
								<?php }
									...
									if((strtoupper($_SESSION['admin_login'])=='ADMIN' ||strtoupper($_SESSION['admin_login'])=='SUPERVISOR') &&  strtoupper($_SESSION['nick_name'])=='EMAMI'){
                                ...
                                <td><?php if($_SESSION['admin_login']!='' && survey == 'yes' && strtoupper($_SESSION['nick_name'])!='STAR' && strtoupper($_SESSION['nick_name'])!='CASHLESS'){?><a href="survey_output_edit.php" name="link30" id="link30" onMouseOver="MM_showMenu(window.mm_menu_0716141230_0,0,26,null,'link30')" onMouseOut="MM_startTimeout();" >Survey</a><?php } ?>
                                </td>
                                <td><?php 
...
<?php 
			...
			if(collection == 'yes' && strtoupper($_SESSION['nick_name'])!='MAITHAN'){?>
                                 ...
                                 <?php }else if(strtoupper($_SESSION['nick_name'])!='STAR' && strtoupper($_SESSION['nick_name'])!='CASHLESS' && strtoupper($_SESSION['nick_name'])!='PARLE' && strtoupper($_SESSION['nick_name'])!='UCLINDIA' && strtoupper($_SESSION['nick_name'])!='MAITHAN'){ ?>
            ...
            <a href="#" name="link63" id="link63" onMouseOver="MM_showMenu(window.mm_menu_0716141863_0,0,26,null,'link63')" onMouseOut="MM_startTimeout();">Customize Report</a>
                                 <?php } else if(strtoupper($_SESSION['nick_name'])=='STAR' && $_SESSION['admin_login']!='emovesfa_hr'){?>
...
<?php } else if($_SESSION['admin_login']!='' && (strtoupper($_SESSION['nick_name'])=='EMAMI' || strtoupper($_SESSION['nick_name'])=='EMAMIT')){ ?>
                                 ...
                                 <?php } else if($_SESSION['admin_login']!='' && (strtoupper($_SESSION['nick_name'])=='VIPL'))
								 { ?>
							 ...
							 if(strtoupper($_SESSION['admin_login']) =='SYSTEM')
							{
                                ...
                                <?php
								if(strtoupper($_SESSION['nick_name'])=='ABDOS' || strtoupper($_SESSION['nick_name'])=='ABDOST'){
									?>
                                    <td>
                                ...
                                <?php
										}elseif(strtoupper($_SESSION['nick_name'])!='EMAMI' && $_SESSION['admin_login']!='emovesfa_hr'){?>
                                ...
                                <?php
									if($_SESSION['admin_login']!=''){
											if((sauda_allocation == 'yes' && $reporting_to_total>0) || (sauda_allocation == 'yes' && $_SESSION['admin_login'] == 'admin')){
									...
									<?php
										...
										?>
									<a href="generate_pricing_details_new.php" name="link51" id="link51" onMouseOver="MM_showMenu(window.mm_menu_0716141851_0,0,26,null,'link51')" onMouseOut="MM_startTimeout();">Pricing</a>
										<?php
									}
								  }
                                ...
                                <td>
                                <?php 
								if(strtoupper($_SESSION['admin_login'])){
								?>
