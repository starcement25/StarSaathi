...
function show_sub_next_level(page_href,prod_sub_group_code,start_date,end_date,type){
	document.getElementById("display_sub_sub_details").innerHTML = '';
	document.getElementById("display_sub_details").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction(''+page_href+'?prod_sub_group_code='+prod_sub_group_code+'&start_date='+start_date+'&end_date='+end_date+'&type='+type,'display_sub_details',0);
...
function show_sub_sub_next_level(page_href,prod_brand_code,start_date,end_date,type){
	document.getElementById("display_sub_sub_details").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction(''+page_href+'?prod_brand_code='+prod_brand_code+'&start_date='+start_date+'&end_date='+end_date+'&type='+type,'display_sub_sub_details',0);
