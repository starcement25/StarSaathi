		  ...
		  <td align="right">Vertical value*</td>
			...
			<td><select name='vertical_value' id='vertical_value'>
            	<?php $sqlselvertical="SELECT DISTINCT vertical_value FROM product_master";
					  $rsselvertical=mysql_query($sqlselvertical);
					  while($rowselvertical=mysql_fetch_array($rsselvertical))
                	  {
				?>
			...
			foreach($lines as $line)
			{
				...
				{ 
				  ...
				  //print_r($data);
					...
					$sqlinsertlog .= " , vertical_value='".mysql_real_escape_string($vertical_value)."'";
