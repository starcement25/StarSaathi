...
require ("attribute_selection_new_dcr.php");
...
function main(){
	...
	function display_result(){
		...
		var semployee = encodeURIComponent(document.getElementById("employee").value);
		var employee=semployee.substring(1, semployee.length-1);
		var dateval = encodeURIComponent(document.getElementById("start_date").value);
		...
		GenericAjaxFunction('selectEmployeeWiseActivitynew.php?emp_code='+employee+'&frm_date='+newdate+'&mode=MTD&page=misreport','display',0);
