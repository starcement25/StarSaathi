...
while($row_vertical = mysql_fetch_array($res_vertical))
{
	...
	$sql_employee_access = "SELECT EM.emp_code, EM.dns_emp_code, EM.emp_name, EM.HQ, EM.designation, EM.branch_code FROM employee_master EM WHERE FIND_IN_SET('".$distinct_vertical_value."',EM.vertical_value) AND EM.acedns = 'N'  ORDER BY EM.emp_name";
