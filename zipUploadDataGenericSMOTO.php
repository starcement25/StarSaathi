				  ...
				  //print_r($data);
					...
					else
					{
						...
						if($product_group_name_existing!=$product_group_name)
						{
							...
							$sqlupdatebrandform .= " , product_group_code='".mysql_escape_string($product_group_name)."'";
			...
			foreach($lines as $line)
			{
				...
				//print_r($data);
					...
					if($countskunamechk<1)
					{
						...
						$sql .= " , prod_desc='".mysql_escape_string($prod_desc)."'";
				  ...
				  //print_r($data);
					...
					else
					{
						...
						if($mrp_db!=$mrp || $sale_rate_db!=$sale_rate){
							...
							$sqlupdate .= " SET mrp='".mysql_escape_string($mrp)."'";
							$sqlupdate .= " , sale_rate='".mysql_escape_string($sale_rate)."'";
