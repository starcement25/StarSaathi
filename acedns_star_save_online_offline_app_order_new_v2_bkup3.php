...
$sqlin = "insert into $t_apperpdo (`ERPORDERNO`,`ERPORDERDT`,`order_date`,`order_for`,`order_for_type`,`consignee_name`,`consignee_address`,`sub_dealer_code`,`dns_sub_dealer_code`,`customer_code`,`dns_customer_code`,`prod_code`,`dns_prod_code`,`prod_display_name`,`QTY`,`freight`,`branch_code`,`dns_branch_code`,`destination_code`,`destination_name`,`destination_address`,`phone_no`,`dump_status`,`dump_code`,`dump_name`,`order_from`,`order_by`,`dealer_truck`) values('$erporderno','$erporderdt','$order_date','$order_for_new_in','$order_for_type','$consignee_name_of','$consignee_address_of','$sub_dealer_code','$dns_sub_dealer_code','$customer_code','$dns_customer_code','$prod_code','$dns_prod_code','$prod_dtld_desc','$qty','$freight','$branch_code','$dns_branch_code','$destination_code','$destination_name','$destination_address','$phone_no','$dump_status','$dump_code','$dump_name','$user_type','$login_user_id','$dealer_truck')";
...
$sqlin_temp = "insert into $t_apperpdo_temp (`APPORDERNO`,`ERPORDERNO`,`ERPORDERDT`,`order_date`,`order_for`,`order_for_type`,`consignee_name`,`consignee_address`,`sub_dealer_code`,`dns_sub_dealer_code`,`customer_code`,`dns_customer_code`,`prod_code`,`dns_prod_code`,`prod_display_name`,`QTY`,`freight`,`branch_code`,`dns_branch_code`,`destination_code`,`destination_name`,`destination_address`,`phone_no`,`dump_status`,`dump_code`,`dump_name`,`order_from`,`order_by`,`dealer_truck`) values('$apporderno','$erporderno','$erporderdt','$order_date','$order_for_new_in','$order_for_type','$consignee_name_of','$consignee_address_of','$sub_dealer_code','$dns_sub_dealer_code','$customer_code','$dns_customer_code','$prod_code','$dns_prod_code','$prod_dtld_desc','$qty','$freight','$branch_code','$dns_branch_code','$destination_code','$destination_name','$destination_address','$phone_no','$dump_status','$dump_code','$dump_name','$user_type','$login_user_id','$dealer_truck')";
...
$dns_sub_dealer_code = show_dns_customer_from_customer_code_code($sub_dealer_code);
		...
		$sqlin = "insert into $t_apperpdo (`APPORDERNO`,`ERPORDERNO`,`ERPORDERDT`,`order_date`,`order_for`,`sub_dealer_code`,`dns_sub_dealer_code`,`customer_code`,`dns_customer_code`,`prod_code`,`dns_prod_code`,`prod_display_name`,`QTY`,`freight`,`destination_code`,`destination_name`,`destination_address`,`phone_no`,`dump_status`,`dump_code`,`dump_name`,`order_from`,`order_by`,`dealer_truck`) values('$apporderno','$erporderno','$erporderdt','$order_date','$order_for_new_in','$sub_dealer_code','$dns_sub_dealer_code','$customer_code','$dns_customer_code','$prod_code','$dns_prod_code','$prod_desc',
	'$qty','$freight','$destination_code','$destination_name','$destination_address','$phone_no','$dump_status','$dump_code','$dump_name','$user_type','$login_user_id','$dealer_truck')";
		...
		$sqlinapproval = "insert into T_APPERPDO_APPROVAL(`APPORDERNO`,`ERPORDERNO`,`ERPORDERDT`,`order_date`,`order_for`,`sub_dealer_code`,`dns_sub_dealer_code`,`customer_code`,`dns_customer_code`,`prod_code`,`dns_prod_code`,`prod_display_name`,`QTY`,`freight`,`destination_code`,`destination_name`,`destination_address`,`phone_no`,`dump_status`,`dump_code`,`dump_name`,`order_from`,`order_by`,`dealer_truck`) values('$apporderno','$erporderno','$erporderdt','$order_date','$order_for_new_in','$sub_dealer_code','$dns_sub_dealer_code','$customer_code','$dns_customer_code','$prod_code','$dns_prod_code','$prod_desc',
	'$qty','$freight','$destination_code','$destination_name','$destination_address','$phone_no','$dump_status','$dump_code','$dump_name','$user_type','$login_user_id','$dealer_truck')";
		...
		$final_email=substr($email_hierarchy,0,-1).','.','.'kaushikshrivastava@starcement.co.in'.','.substr($email_broker,0,-1);
		...
		$message="Order received from Dealer @ $hour:$minute";
